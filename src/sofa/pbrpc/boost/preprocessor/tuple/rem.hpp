...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_TUPLE_REM_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_TUPLE_REM_HPP
#
# include <sofa/pbrpc/boost/preprocessor/cat.hpp>
# include <sofa/pbrpc/boost/preprocessor/config/config.hpp>
# include <sofa/pbrpc/boost/preprocessor/facilities/expand.hpp>
# include <sofa/pbrpc/boost/preprocessor/facilities/overload.hpp>
# include <sofa/pbrpc/boost/preprocessor/tuple/detail/is_single_return.hpp>
#
# /* BOOST_PP_REM */
#
