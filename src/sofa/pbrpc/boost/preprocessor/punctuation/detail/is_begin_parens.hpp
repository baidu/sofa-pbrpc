...
#
#ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_BEGIN_PARENS_HPP
#define SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_BEGIN_PARENS_HPP
...
#endif /* SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_BEGIN_PARENS_HPP */
