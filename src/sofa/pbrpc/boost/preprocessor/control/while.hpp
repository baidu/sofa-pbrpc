...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_CONTROL_WHILE_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_CONTROL_WHILE_HPP
#
...
#
#include <sofa/pbrpc/boost/preprocessor/control/detail/while.hpp>
#
