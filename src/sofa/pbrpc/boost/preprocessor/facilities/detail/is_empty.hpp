...
#
#ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_EMPTY_HPP
#define SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_EMPTY_HPP
...
#endif /* SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_EMPTY_HPP */
