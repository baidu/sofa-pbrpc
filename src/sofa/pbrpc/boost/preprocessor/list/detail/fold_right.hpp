...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_DETAIL_FOLD_RIGHT_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_DETAIL_FOLD_RIGHT_HPP
#
# include <sofa/pbrpc/boost/preprocessor/list/fold_left.hpp>
# include <sofa/pbrpc/boost/preprocessor/list/reverse.hpp>
#
