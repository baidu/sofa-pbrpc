...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_FOLD_LEFT_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_FOLD_LEFT_HPP
#
...
#
#include <sofa/pbrpc/boost/preprocessor/list/detail/fold_left.hpp>
#
