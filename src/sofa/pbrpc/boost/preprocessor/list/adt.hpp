...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_ADT_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_LIST_ADT_HPP
#
# include <sofa/pbrpc/boost/preprocessor/config/config.hpp>
# include <sofa/pbrpc/boost/preprocessor/detail/is_binary.hpp>
