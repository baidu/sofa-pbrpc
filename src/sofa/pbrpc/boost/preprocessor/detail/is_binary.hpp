...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_BINARY_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_DETAIL_IS_BINARY_HPP
#
# include <sofa/pbrpc/boost/preprocessor/config/config.hpp>
# include <sofa/pbrpc/boost/preprocessor/detail/check.hpp>
#
# /* BOOST_PP_IS_BINARY */
#
