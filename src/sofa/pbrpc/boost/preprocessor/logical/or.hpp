...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_LOGICAL_OR_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_LOGICAL_OR_HPP
#
# include <sofa/pbrpc/boost/preprocessor/config/config.hpp>
# include <sofa/pbrpc/boost/preprocessor/logical/bool.hpp>
# include <sofa/pbrpc/boost/preprocessor/logical/bitor.hpp>
#
# /* BOOST_PP_OR */
#
