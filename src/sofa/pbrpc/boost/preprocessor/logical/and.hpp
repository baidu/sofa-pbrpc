...
#
# ifndef SOFA_PBRPC_BOOST_PREPROCESSOR_LOGICAL_AND_HPP
# define SOFA_PBRPC_BOOST_PREPROCESSOR_LOGICAL_AND_HPP
#
# include <sofa/pbrpc/boost/preprocessor/config/config.hpp>
# include <sofa/pbrpc/boost/preprocessor/logical/bool.hpp>
# include <sofa/pbrpc/boost/preprocessor/logical/bitand.hpp>
#
# /* BOOST_PP_AND */
#
