...
#ifndef SOFA_PBRPC_BOOST_ERROR_CODE_HPP
#define SOFA_PBRPC_BOOST_ERROR_CODE_HPP
...
#include <sofa/pbrpc/boost/config/abi_prefix.hpp> // must be the last #include
...
# endif
    ...
    //
    //       <sofa/pbrpc/boost/system/cygwin_error.hpp>
    //       <sofa/pbrpc/boost/system/linux_error.hpp>
    //       <sofa/pbrpc/boost/system/windows_error.hpp>
    //
    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename sofa::pbrpc::boost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorConditionEnum>
        typename sofa::pbrpc::boost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename sofa::pbrpc::boost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorCodeEnum>
        typename sofa::pbrpc::boost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# endif
    ...
    //  "throws" function in namespace boost rather than namespace sofa::pbrpc::boost::system.
...
#include <sofa/pbrpc/boost/config/abi_suffix.hpp> // pops abi_prefix.hpp pragmas

# ifdef BOOST_ERROR_CODE_HEADER_ONLY
#   include <sofa/pbrpc/boost/system/detail/error_code.ipp>
# endif

#endif // SOFA_PBRPC_BOOST_ERROR_CODE_HPP
