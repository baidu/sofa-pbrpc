...
#ifndef SOFA_PBRPC_BOOST_SYSTEM_CONFIG_HPP                  
#define SOFA_PBRPC_BOOST_SYSTEM_CONFIG_HPP

#include <sofa/pbrpc/boost/config.hpp>
#include <sofa/pbrpc/boost/predef/platform.h>
#include <sofa/pbrpc/boost/system/api_config.hpp>  // for BOOST_POSIX_API or BOOST_WINDOWS_API
...
#endif // SOFA_PBRPC_BOOST_SYSTEM_CONFIG_HPP
