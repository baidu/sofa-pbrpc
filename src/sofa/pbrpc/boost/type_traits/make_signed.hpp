...
#ifndef SOFA_PBRPC_BOOST_TT_MAKE_SIGNED_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_MAKE_SIGNED_HPP_INCLUDED
...
struct make_signed_imp
{
   ...
   typedef typename mpl::if_c<
      (::sofa::pbrpc::boost::type_traits::ice_and< 
         ::sofa::pbrpc::boost::is_signed<T>::value,
            ...
            typename mpl::if_<
               ...
               typename mpl::if_<
                  ...
                  typename mpl::if_<
                     ...
                     typename mpl::if_c<
                        sizeof(t_no_cv) == sizeof(sofa::pbrpc::boost::long_long_type), 
                        sofa::pbrpc::boost::long_long_type, 
                        sofa::pbrpc::boost::int128_type
                     >::type
#else
                     sofa::pbrpc::boost::long_long_type
#endif
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(make_signed,T,typename sofa::pbrpc::boost::detail::make_signed_imp<T>::type)
