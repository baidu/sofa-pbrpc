...
#ifndef SOFA_PBRPC_BOOST_TT_REMOVE_BOUNDS_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_REMOVE_BOUNDS_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_TT_REMOVE_BOUNDS_HPP_INCLUDED
