...
#ifndef SOFA_PBRPC_BOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/type_traits/detail/size_t_trait_def.hpp>
...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::sofa::pbrpc::boost::detail::alignment_logic<
            sizeof(::sofa::pbrpc::boost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
BOOST_TT_AUX_SIZE_T_TRAIT_DEF1(alignment_of,T,::sofa::pbrpc::boost::detail::alignment_of_impl<T>::value)
...
#include <sofa/pbrpc/boost/type_traits/detail/size_t_trait_undef.hpp>

#endif // SOFA_PBRPC_BOOST_TT_ALIGNMENT_OF_HPP_INCLUDED
