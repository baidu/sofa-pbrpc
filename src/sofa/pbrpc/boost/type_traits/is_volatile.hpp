...
#ifndef SOFA_PBRPC_BOOST_TT_IS_VOLATILE_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_VOLATILE_HPP_INCLUDED
...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::sofa::pbrpc::boost::detail::cv_traits_imp<typename sofa::pbrpc::boost::remove_bounds<T>::type*>::is_volatile);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::sofa::pbrpc::boost::detail::cv_traits_imp<BOOST_TT_AUX_CV_TRAITS_IMPL_PARAM(T)>::is_volatile);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::sofa::pbrpc::boost::detail::is_volatile_rval_filter<T>::value)
...
#endif // SOFA_PBRPC_BOOST_TT_IS_VOLATILE_HPP_INCLUDED
