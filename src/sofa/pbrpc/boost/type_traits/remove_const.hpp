...
#ifndef SOFA_PBRPC_BOOST_TT_REMOVE_CONST_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_REMOVE_CONST_HPP_INCLUDED
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_const,T,typename sofa::pbrpc::boost::detail::remove_const_impl<T>::type)
...
#endif // SOFA_PBRPC_BOOST_TT_REMOVE_CONST_HPP_INCLUDED
