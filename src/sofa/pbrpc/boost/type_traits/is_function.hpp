...
#ifndef SOFA_PBRPC_BOOST_TT_IS_FUNCTION_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_FUNCTION_HPP_INCLUDED
...
#   include <sofa/pbrpc/boost/type_traits/detail/is_function_ptr_helper.hpp>
#else
#   include <sofa/pbrpc/boost/type_traits/detail/is_function_ptr_tester.hpp>
...
struct is_function_chooser<false>
{
    template< typename T > struct result_
        : public ::sofa::pbrpc::boost::type_traits::is_function_ptr_helper<T*>
    {
    };
};
...
struct is_function_impl
    : public is_function_chooser< ::sofa::pbrpc::boost::is_reference<T>::value >
...
#pragma warning(disable:6334)
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(::sofa::pbrpc::boost::type_traits::is_function_ptr_tester(t))
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_function,T,::sofa::pbrpc::boost::detail::is_function_impl<T>::value)
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
...
#endif // SOFA_PBRPC_BOOST_TT_IS_FUNCTION_HPP_INCLUDED
