...
#ifndef SOFA_PBRPC_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::sofa::pbrpc::boost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::sofa::pbrpc::boost::is_class<B>::value,
       ::sofa::pbrpc::boost::is_class<D>::value,
       ::sofa::pbrpc::boost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::sofa::pbrpc::boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::sofa::pbrpc::boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
