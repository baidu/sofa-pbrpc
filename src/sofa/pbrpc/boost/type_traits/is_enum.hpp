...
#ifndef SOFA_PBRPC_BOOST_TT_IS_ENUM_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_ENUM_HPP_INCLUDED
...
struct is_class_or_union
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::sofa::pbrpc::boost::type_traits::ice_or<
           ::sofa::pbrpc::boost::is_class<T>::value
         , ::sofa::pbrpc::boost::is_union<T>::value
      >::value));
};
...
# else
    template <class U> static ::sofa::pbrpc::boost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::sofa::pbrpc::boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type));
#  else
    template <class U>
    static ::sofa::pbrpc::boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::sofa::pbrpc::boost::is_convertible<typename sofa::pbrpc::boost::add_reference<T>::type,::sofa::pbrpc::boost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::sofa::pbrpc::boost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::sofa::pbrpc::boost::type_traits::ice_or<
         ...
         , ::sofa::pbrpc::boost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::sofa::pbrpc::boost::detail::is_enum_helper<
          ::sofa::pbrpc::boost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::sofa::pbrpc::boost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::sofa::pbrpc::boost::detail::is_enum_impl<T>::value)
...
#endif // SOFA_PBRPC_BOOST_TT_IS_ENUM_HPP_INCLUDED
