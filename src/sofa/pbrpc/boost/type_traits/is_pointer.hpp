...
#ifndef SOFA_PBRPC_BOOST_TT_IS_POINTER_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_POINTER_HPP_INCLUDED
...
struct is_pointer_impl
{
    BOOST_STATIC_CONSTANT(bool, value =
        ...
        ::sofa::pbrpc::boost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::sofa::pbrpc::boost::detail::is_pointer_impl<T>::value)
...
#endif // SOFA_PBRPC_BOOST_TT_IS_POINTER_HPP_INCLUDED
