...
#ifndef SOFA_PBRPC_BOOST_TYPE_TRAITS_COMMON_TYPE_HPP
#define SOFA_PBRPC_BOOST_TYPE_TRAITS_COMMON_TYPE_HPP
...
#include <sofa/pbrpc/boost/typeof/typeof.hpp>   // sofa/pbrpc/boost wonders never cease!
#endif
...
#define BOOST_COMMON_TYPE_STATIC_ASSERT(CND, MSG, TYPES)                                 \
    BOOST_MPL_ASSERT_MSG(sofa::pbrpc::boost::mpl::bool_< (CND) >::type::value, MSG, TYPES)
#else
...
#if defined(BOOST_NO_CXX11_DECLTYPE) && defined(BOOST_COMMON_TYPE_DONT_USE_TYPEOF)
#include <sofa/pbrpc/boost/type_traits/detail/common_type_imp.hpp>
...
#endif  // SOFA_PBRPC_BOOST_TYPE_TRAITS_COMMON_TYPE_HPP
