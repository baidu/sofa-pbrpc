...
#ifndef SOFA_PBRPC_BOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED
...
#define BOOST_TT_FORBIDDEN_IF\
   ::sofa::pbrpc::boost::type_traits::ice_or<\
      ...
      ::sofa::pbrpc::boost::type_traits::ice_and<\
         ::sofa::pbrpc::boost::is_pointer< Rhs_noref >::value,\
         ::sofa::pbrpc::boost::is_fundamental< Lhs_nocv >::value,\
         ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same< Lhs_nocv, bool >::value >::value\
      >::value,\
