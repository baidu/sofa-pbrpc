...
#ifndef SOFA_PBRPC_BOOST_TT_TYPE_WITH_ALIGNMENT_INCLUDED
#define SOFA_PBRPC_BOOST_TT_TYPE_WITH_ALIGNMENT_INCLUDED
...
#include <sofa/pbrpc/boost/preprocessor/list/transform.hpp>
#include <sofa/pbrpc/boost/preprocessor/list/append.hpp>
...
#define BOOST_TT_ALIGNMENT_BASE_TYPES BOOST_PP_TUPLE_TO_LIST( \
        12, ( \
        char, short, int, long,  ::sofa::pbrpc::boost::long_long_type, float, double, long double \
...
#define BOOST_TT_HAS_ONE_T(D,Data,T) sofa::pbrpc::boost::detail::has_one_T< T >
...
struct is_pod< ::sofa::pbrpc::boost::detail::lower_alignment<Align> >
{
...
{
    typedef ::sofa::pbrpc::boost::detail::lower_alignment<Align> t1;
    typedef typename mpl::if_c<
          ::sofa::pbrpc::boost::detail::is_aligned< ::sofa::pbrpc::boost::alignment_of<t1>::value,Align >::value
        , t1
        , ::sofa::pbrpc::boost::detail::max_align
        >::type align_t;
...
class type_with_alignment 
  : public ::sofa::pbrpc::boost::detail::type_with_alignment_imp<Align>
{
};
...
namespace detail {
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a2,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a4,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a8,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a16,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a32,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a64,true)
BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_pod,::sofa::pbrpc::boost::tt_align_ns::a128,true)
}
#endif
...
{ 
   typedef mpl::if_c<
      ::sofa::pbrpc::boost::alignment_of<sofa::pbrpc::boost::detail::max_align>::value < 8,
      tt_align_ns::a8,
      sofa::pbrpc::boost::detail::type_with_alignment_imp<8> >::type t1; 
public: 
...
{ 
   typedef mpl::if_c<
      ::sofa::pbrpc::boost::alignment_of<sofa::pbrpc::boost::detail::max_align>::value < 16,
      tt_align_ns::a16,
      sofa::pbrpc::boost::detail::type_with_alignment_imp<16> >::type t1; 
public: 
   typedef t1::type type;
};
...
{ 
   typedef mpl::if_c<
      ::sofa::pbrpc::boost::alignment_of<sofa::pbrpc::boost::detail::max_align>::value < 32,
      tt_align_ns::a32,
      sofa::pbrpc::boost::detail::type_with_alignment_imp<32> >::type t1; 
public: 
   typedef t1::type type;
};
template<> class type_with_alignment<64> {
   typedef mpl::if_c<
      ::sofa::pbrpc::boost::alignment_of<sofa::pbrpc::boost::detail::max_align>::value < 64,
      tt_align_ns::a64,
      sofa::pbrpc::boost::detail::type_with_alignment_imp<64> >::type t1; 
public: 
   typedef t1::type type;
};
template<> class type_with_alignment<128> {
   typedef mpl::if_c<
      ::sofa::pbrpc::boost::alignment_of<sofa::pbrpc::boost::detail::max_align>::value < 128,
      tt_align_ns::a128,
      sofa::pbrpc::boost::detail::type_with_alignment_imp<128> >::type t1; 
public: 
   typedef t1::type type;
};
...
typedef ::sofa::pbrpc::boost::tt_align_ns::a16 max_align;
...
#endif // SOFA_PBRPC_BOOST_TT_TYPE_WITH_ALIGNMENT_INCLUDED
