...
#include <sofa/pbrpc/boost/type_traits/is_polymorphic.hpp>
#endif
#endif
...
struct is_abstract_imp
{
   typedef is_abstract_select< ::sofa::pbrpc::boost::is_class<T>::value> selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::sofa::pbrpc::boost::detail::is_abstract_imp<T>::value)
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_abstract,T,::sofa::pbrpc::boost::detail::is_polymorphic_imp<T>::value)
#endif
