...
#ifndef SOFA_PBRPC_BOOST_TT_REMOVE_POINTER_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_REMOVE_POINTER_HPP_INCLUDED
...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename sofa::pbrpc::boost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::sofa::pbrpc::boost::is_pointer<T>::value>::type type;
   };
}

BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename sofa::pbrpc::boost::detail::remove_pointer_imp2<T>::type)
...
#endif // SOFA_PBRPC_BOOST_TT_REMOVE_POINTER_HPP_INCLUDED
