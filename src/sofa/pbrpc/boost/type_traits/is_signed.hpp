...
#ifndef SOFA_PBRPC_BOOST_TT_IS_SIGNED_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_SIGNED_HPP_INCLUDED
...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::sofa::pbrpc::boost::detail::is_signed_values<T>::minus_one  > sofa::pbrpc::boost::detail::is_signed_values<T>::zero)));
};
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::sofa::pbrpc::boost::detail::is_signed_imp<T>::value)
#endif
