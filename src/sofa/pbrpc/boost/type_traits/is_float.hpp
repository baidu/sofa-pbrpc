...
#ifndef SOFA_PBRPC_BOOST_TYPE_TRAITS_IS_FLOAT_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TYPE_TRAITS_IS_FLOAT_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_TYPE_TRAITS_IS_FLOAT_HPP_INCLUDED
