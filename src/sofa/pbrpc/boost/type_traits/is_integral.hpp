...
#ifndef SOFA_PBRPC_BOOST_TT_IS_INTEGRAL_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_INTEGRAL_HPP_INCLUDED
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::sofa::pbrpc::boost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::sofa::pbrpc::boost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,sofa::pbrpc::boost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,sofa::pbrpc::boost::uint128_type,true)
#endif
...
#endif // SOFA_PBRPC_BOOST_TT_IS_INTEGRAL_HPP_INCLUDED
