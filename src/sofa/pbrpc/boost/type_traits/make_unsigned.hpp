...
#ifndef SOFA_PBRPC_BOOST_TT_MAKE_UNSIGNED_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_MAKE_UNSIGNED_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/type_traits/is_unsigned.hpp>
...
#include <sofa/pbrpc/boost/type_traits/add_volatile.hpp>
...
{
   BOOST_STATIC_ASSERT(
      (::sofa::pbrpc::boost::type_traits::ice_or< ::sofa::pbrpc::boost::is_integral<T>::value, ::sofa::pbrpc::boost::is_enum<T>::value>::value));
   BOOST_STATIC_ASSERT(
      (::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<
         typename remove_cv<T>::type, bool>::value>::value));

   typedef typename remove_cv<T>::type t_no_cv;
   typedef typename mpl::if_c<
      (::sofa::pbrpc::boost::type_traits::ice_and< 
         ::sofa::pbrpc::boost::is_unsigned<T>::value,
         ::sofa::pbrpc::boost::is_integral<T>::value,
         ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, char>::value>::value,
         ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, wchar_t>::value>::value,
         ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, bool>::value>::value >::value),
      T,
      typename mpl::if_c<
         (::sofa::pbrpc::boost::type_traits::ice_and< 
            ::sofa::pbrpc::boost::is_integral<T>::value,
            ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, char>::value>::value,
            ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, wchar_t>::value>::value,
            ::sofa::pbrpc::boost::type_traits::ice_not< ::sofa::pbrpc::boost::is_same<t_no_cv, bool>::value>::value>
         ::value),
         typename mpl::if_<
            ...
            typename mpl::if_<
               ...
               typename mpl::if_<
                  ...
                  typename mpl::if_<
                     ...
                     typename mpl::if_c<
                        sizeof(t_no_cv) == sizeof(sofa::pbrpc::boost::ulong_long_type), 
                        sofa::pbrpc::boost::ulong_long_type, 
                        sofa::pbrpc::boost::uint128_type
                     >::type
#else
                     sofa::pbrpc::boost::ulong_long_type
#endif
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(make_unsigned,T,typename sofa::pbrpc::boost::detail::make_unsigned_imp<T>::type)
