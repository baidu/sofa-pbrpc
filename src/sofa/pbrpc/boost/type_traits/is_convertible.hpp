...
#ifndef SOFA_PBRPC_BOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/type_traits/is_abstract.hpp>
#endif
#include <sofa/pbrpc/boost/type_traits/add_lvalue_reference.hpp>
#include <sofa/pbrpc/boost/type_traits/add_rvalue_reference.hpp>
...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<sofa::pbrpc::boost::is_void<From>, sofa::pbrpc::boost::is_function<To>, sofa::pbrpc::boost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(sofa::pbrpc::boost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::sofa::pbrpc::boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::sofa::pbrpc::boost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static sofa::pbrpc::boost::type_traits::no_type _m_check(any_conversion ...);
    static sofa::pbrpc::boost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( sofa::pbrpc::boost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::sofa::pbrpc::boost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( sofa::pbrpc::boost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::sofa::pbrpc::boost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::sofa::pbrpc::boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::sofa::pbrpc::boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::sofa::pbrpc::boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::sofa::pbrpc::boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::sofa::pbrpc::boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::sofa::pbrpc::boost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::sofa::pbrpc::boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::sofa::pbrpc::boost::is_function<typename ::sofa::pbrpc::boost::remove_reference<From>::type>::value
  >
{};
    ...
    enum { value =
        (::sofa::pbrpc::boost::type_traits::ice_and<
            ::sofa::pbrpc::boost::type_traits::ice_or<
               ::sofa::pbrpc::boost::detail::is_convertible_basic_impl<From,To>::value,
               ::sofa::pbrpc::boost::is_void<To>::value
            >::value,
            ::sofa::pbrpc::boost::type_traits::ice_not<
               ::sofa::pbrpc::boost::is_array<To>::value
            >::value,
            ::sofa::pbrpc::boost::type_traits::ice_not<
               ::sofa::pbrpc::boost::is_function<To>::value
            >::value
        >::value) };
};
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::sofa::pbrpc::boost::is_arithmetic<From>::value, 
      ::sofa::pbrpc::boost::is_arithmetic<To>::value,
      ...
      ::sofa::pbrpc::boost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::sofa::pbrpc::boost::detail::is_convertible_impl_dispatch<From,To>::value))
...
#endif // SOFA_PBRPC_BOOST_TT_IS_CONVERTIBLE_HPP_INCLUDED
