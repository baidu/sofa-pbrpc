...
#ifndef SOFA_PBRPC_BOOST_TT_IS_MEMBER_POINTER_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_MEMBER_POINTER_HPP_INCLUDED
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_pointer,T,::sofa::pbrpc::boost::is_member_function_pointer<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_2(typename T,typename U,is_member_pointer,U T::*,true)
...
#endif // SOFA_PBRPC_BOOST_TT_IS_MEMBER_POINTER_HPP_INCLUDED
