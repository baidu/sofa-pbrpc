...
#ifndef SOFA_PBRPC_BOOST_TT_ADD_VOLATILE_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_ADD_VOLATILE_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_TT_ADD_VOLATILE_HPP_INCLUDED
