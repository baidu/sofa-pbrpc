...
#ifndef SOFA_PBRPC_BOOST_TT_IS_FINAL_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_TT_IS_FINAL_HPP_INCLUDED
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_final,T,::sofa::pbrpc::boost::detail::is_final_impl<T>::value)
...
#endif // SOFA_PBRPC_BOOST_TT_IS_FINAL_HPP_INCLUDED
