...
#ifndef SOFA_PBRPC_BOOST_INTEGER_COMMON_FACTOR_RT_HPP
#define SOFA_PBRPC_BOOST_INTEGER_COMMON_FACTOR_RT_HPP

#include <sofa/pbrpc/boost/integer_fwd.hpp>  // self include

#include <sofa/pbrpc/boost/config.hpp>  // for BOOST_NESTED_TEMPLATE, etc.
...
};  // sofa::pbrpc::boost::integer::gcd_evaluator
...
};  // sofa::pbrpc::boost::integer::lcm_evaluator
...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( sofa::pbrpc::boost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( sofa::pbrpc::boost::long_long_type, sofa::pbrpc::boost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
...
#endif  // SOFA_PBRPC_BOOST_INTEGER_COMMON_FACTOR_RT_HPP
