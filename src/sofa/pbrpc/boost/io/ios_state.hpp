...
#ifndef SOFA_PBRPC_BOOST_IO_IOS_STATE_HPP
#define SOFA_PBRPC_BOOST_IO_IOS_STATE_HPP

#include <sofa/pbrpc/boost/io_fwd.hpp>  // self include
...
#endif  // SOFA_PBRPC_BOOST_IO_IOS_STATE_HPP
