...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_HPP

#include <sofa/pbrpc/boost/config.hpp> /* keep it first to prevent nasty warns in MSVC */
#include <algorithm>
#include <sofa/pbrpc/boost/detail/allocator_utilities.hpp>
...
#include <sofa/pbrpc/boost/multi_index_container_fwd.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/access_specifier.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/adl_swap.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/base_type.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/converter.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/header_holder.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/has_tag.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/no_duplicate_tags.hpp>
...
#include <sofa/pbrpc/boost/utility/base_from_member.hpp>
...
#include <sofa/pbrpc/boost/multi_index/detail/archive_constructed.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/serialization_version.hpp>
#include <sofa/pbrpc/boost/serialization/collection_size_type.hpp>
#include <sofa/pbrpc/boost/serialization/nvp.hpp>
...
#include <sofa/pbrpc/boost/multi_index/detail/invariant_assert.hpp>
...
class multi_index_container:
  private ::sofa::pbrpc::boost::base_from_member<
    typename sofa::pbrpc::boost::detail::allocator::rebind_to<
      Allocator,
...
private:
  ...
  typedef typename
  sofa::pbrpc::boost::detail::allocator::rebind_to<
    Allocator,
    typename super::node_type
  >::type                                         node_allocator;
  typedef ::sofa::pbrpc::boost::base_from_member<
    ...
    BOOST_TRY{
      ...
      BOOST_TRY{
        ...
        if(res==x){
          ...
          sofa::pbrpc::boost::detail::allocator::destroy(&x->value());
          deallocate_node(x);
          return std::pair<node_type*,bool>(res,false);
        }
      }
...
>
typename ::sofa::pbrpc::boost::multi_index::index<
  ...
  multi_index_container<Value,IndexSpecifierList,Allocator>& m)BOOST_NOEXCEPT
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::sofa::pbrpc::boost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index_type;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::sofa::pbrpc::boost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
)BOOST_NOEXCEPT
 ...
 * sofa::pbrpc::boost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  sofa::pbrpc::boost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
