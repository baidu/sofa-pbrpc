...
#ifndef SOFA_PBRPC_BOOST_RANGE_CONCEPTS_HPP
#define SOFA_PBRPC_BOOST_RANGE_CONCEPTS_HPP

#include <sofa/pbrpc/boost/concept_check.hpp>
#include <sofa/pbrpc/boost/iterator/iterator_concepts.hpp>
...
#include <sofa/pbrpc/boost/range/detail/misc_concept.hpp>
...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the sofa::pbrpc::boost::adaptors::filtered
        // class with a sofa::pbrpc::boost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                sofa::pbrpc::boost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::detail::iterator_traits<Iterator>::reference r1(*i);
                sofa::pbrpc::boost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                sofa::pbrpc::boost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                sofa::pbrpc::boost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::detail::iterator_traits<Iterator>::reference r(*(i++));
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = sofa::pbrpc::boost::begin(*m_range);
            iterator i2 = sofa::pbrpc::boost::end(*m_range);

            sofa::pbrpc::boost::ignore_unused_variable_warning(i1);
            sofa::pbrpc::boost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = sofa::pbrpc::boost::begin(const_range);
            const_iterator ci2 = sofa::pbrpc::boost::end(const_range);

            sofa::pbrpc::boost::ignore_unused_variable_warning(ci1);
            sofa::pbrpc::boost::ignore_unused_variable_warning(ci2);
        }
...
#endif // SOFA_PBRPC_BOOST_RANGE_CONCEPTS_HPP
