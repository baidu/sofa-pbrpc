...
// to function types.
//
#ifndef SOFA_PBRPC_BOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_RANGE_ITERATOR_RANGE_CORE_HPP_INCLUDED

#include <sofa/pbrpc/boost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <sofa/pbrpc/boost/iterator/iterator_facade.hpp>
...
#include <sofa/pbrpc/boost/range/functions.hpp>
#include <sofa/pbrpc/boost/range/iterator.hpp>
#include <sofa/pbrpc/boost/range/difference_type.hpp>
#include <sofa/pbrpc/boost/range/has_range_iterator.hpp>
#include <sofa/pbrpc/boost/range/algorithm/equal.hpp>
#include <sofa/pbrpc/boost/range/detail/safe_bool.hpp>
...
namespace boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( sofa::pbrpc::boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( sofa::pbrpc::boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( sofa::pbrpc::boost::begin(l),
                                                 sofa::pbrpc::boost::end(l),
                                                 sofa::pbrpc::boost::begin(r),
                                                 sofa::pbrpc::boost::end(r) );
        }
        ...
        {
            return sofa::pbrpc::boost::equal(l, r);
        }
...
incrementable_t test_traversal_tag(sofa::pbrpc::boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(sofa::pbrpc::boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(sofa::pbrpc::boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef sofa::pbrpc::boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef sofa::pbrpc::boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef sofa::pbrpc::boost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *sofa::pbrpc::boost::prior(this->m_End);
    }
...
public:
    typedef BOOST_DEDUCED_TYPENAME
        sofa::pbrpc::boost::mpl::if_<
            sofa::pbrpc::boost::mpl::or_<
                sofa::pbrpc::boost::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                sofa::pbrpc::boost::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                sofa::pbrpc::boost::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                sofa::pbrpc::boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::enable_if<
            mpl::not_<sofa::pbrpc::boost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, sofa::pbrpc::boost::next(first, n));
        }
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( sofa::pbrpc::boost::begin( r ), sofa::pbrpc::boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = sofa::pbrpc::boost::begin( r ),
                    new_end   = sofa::pbrpc::boost::end( r );
        ...
        */
        ...
        {
            return SeqT( sofa::pbrpc::boost::begin( r ), sofa::pbrpc::boost::end( r ) );
        }
