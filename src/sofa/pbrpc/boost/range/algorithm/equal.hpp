...
//
#ifndef SOFA_PBRPC_BOOST_RANGE_ALGORITHM_EQUAL_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_RANGE_ALGORITHM_EQUAL_HPP_INCLUDED
...
namespace boost
{
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::sofa::pbrpc::boost::range_detail::equal(
                ::sofa::pbrpc::boost::begin(rng1), ::sofa::pbrpc::boost::end(rng1),
                ::sofa::pbrpc::boost::begin(rng2), ::sofa::pbrpc::boost::end(rng2) );
        }
    ...
    using ::sofa::pbrpc::boost::range::equal;
} // namespace boost
} // namespace pbrpc
} // namespace sofa
