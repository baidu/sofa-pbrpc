...
//
#ifndef SOFA_PBRPC_BOOST_RANGE_DETAIL_HAS_MEMBER_SIZE_HPP
#define SOFA_PBRPC_BOOST_RANGE_DETAIL_HAS_MEMBER_SIZE_HPP
...
private:
    ...
    template<class C>
    static sofa::pbrpc::boost::uint8_t f(check<std::size_t(C::*)(void) const, &C::size>*);

    template<class C>
    static sofa::pbrpc::boost::uint16_t f(...);

public:
    static const bool value =
        (sizeof(f<T>(0)) == sizeof(sofa::pbrpc::boost::uint8_t));
