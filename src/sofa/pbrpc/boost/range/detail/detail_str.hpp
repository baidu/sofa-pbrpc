...
#ifndef SOFA_PBRPC_BOOST_RANGE_DETAIL_DETAIL_STR_HPP
#define SOFA_PBRPC_BOOST_RANGE_DETAIL_DETAIL_STR_HPP
...
#include <sofa/pbrpc/boost/range/detail/begin.hpp>
#include <sofa/pbrpc/boost/range/detail/end.hpp>
#include <sofa/pbrpc/boost/range/detail/size_type.hpp>
#include <sofa/pbrpc/boost/range/detail/value_type.hpp>
...
namespace boost 
{
    ...
    namespace range_detail
    {
        ...
        struct range_end<char_array_>
        {
            ...
            {
                return sofa::pbrpc::boost::range_detail::array_end( boost_range_array );
            }
        };
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return sofa::pbrpc::boost::range_detail::str_end( s );
            }
        };
