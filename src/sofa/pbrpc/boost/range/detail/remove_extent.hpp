...
#ifndef SOFA_PBRPC_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define SOFA_PBRPC_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <sofa/pbrpc/boost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
