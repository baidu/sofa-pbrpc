...
//
    ...
    #include <sofa/pbrpc/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_common.hpp>
	
	#if !defined(BOOST_NO_LONG_LONG)
        #include <sofa/pbrpc/boost/numeric/conversion/detail/preprocessed/numeric_cast_traits_long_long.hpp>
	#endif
    ...
    #include <sofa/pbrpc/boost/preprocessor/iteration/iterate.hpp>
...
namespace boost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_A())), <sofa/pbrpc/boost/numeric/conversion/detail/numeric_cast_traits.hpp>))
...
namespace boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(sofa::pbrpc::boost::long_long_type)(sofa::pbrpc::boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (sofa::pbrpc::boost::long_long_type)(sofa::pbrpc::boost::ulong_long_type)
    ...
    #define BOOST_PP_ITERATION_PARAMS_2 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_B())), <sofa/pbrpc/boost/numeric/conversion/detail/numeric_cast_traits.hpp>))
    #include BOOST_PP_ITERATE()
