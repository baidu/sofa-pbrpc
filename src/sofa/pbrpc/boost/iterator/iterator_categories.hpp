...
#ifndef SOFA_PBRPC_BOOST_ITERATOR_CATEGORIES_HPP
#define SOFA_PBRPC_BOOST_ITERATOR_CATEGORIES_HPP
...
struct iterator_category_to_traversal
  : mpl::eval_if< // if already convertible to a traversal tag, we're done.
      ...
      , mpl::identity<Cat>
      , sofa::pbrpc::boost::iterators::detail::old_category_to_traversal<Cat>
    >
{};
...
struct iterator_traversal
  : iterator_category_to_traversal<
        typename sofa::pbrpc::boost::detail::iterator_traits<Iterator>::iterator_category
    >
{};
...
#endif // SOFA_PBRPC_BOOST_ITERATOR_CATEGORIES_HPP
