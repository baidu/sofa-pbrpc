...
#ifndef SOFA_PBRPC_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define SOFA_PBRPC_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP

#include <sofa/pbrpc/boost/iterator.hpp>
#include <sofa/pbrpc/boost/iterator/detail/enable_if.hpp>
#include <sofa/pbrpc/boost/iterator/iterator_adaptor.hpp>
...
#include <sofa/pbrpc/boost/utility/result_of.hpp>
...
namespace iterators {
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public sofa::pbrpc::boost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    sofa::pbrpc::boost::iterators::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
...
#endif // SOFA_PBRPC_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP
