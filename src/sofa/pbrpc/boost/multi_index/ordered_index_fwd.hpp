...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_ORDERED_INDEX_FWD_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_ORDERED_INDEX_FWD_HPP

#if defined(_MSC_VER)
#pragma once
#endif

#include <sofa/pbrpc/boost/multi_index/detail/ord_index_args.hpp>
