...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_MEMBER_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_MEMBER_HPP
...
::sofa::pbrpc::boost::multi_index::member_offset< Class,Type,offsetof(Class,MemberName) >
#else
#define BOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::sofa::pbrpc::boost::multi_index::member< Class,Type,&Class::MemberName >
#endif
