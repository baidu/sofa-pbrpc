...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_INDEXED_BY_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_INDEXED_BY_HPP
...
#include <sofa/pbrpc/boost/preprocessor/control/expr_if.hpp>
