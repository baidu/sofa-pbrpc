...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_ORDERED_INDEX_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_ORDERED_INDEX_HPP
...
#include <sofa/pbrpc/boost/mpl/push_front.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/access_specifier.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/bidir_node_iterator.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/index_node_base.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/modify_key_adaptor.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/ord_index_node.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/ord_index_ops.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/safe_mode.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/scope_guard.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/unbounded.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/value_compare.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/vartempl_support.hpp>
#include <sofa/pbrpc/boost/multi_index/ordered_index_fwd.hpp>
#include <sofa/pbrpc/boost/ref.hpp>
#include <sofa/pbrpc/boost/tuple/tuple.hpp>
...
//#include <sofa/pbrpc/boost/archive/archive_exception.hpp>
//#include <sofa/pbrpc/boost/bind.hpp>
//#include <sofa/pbrpc/boost/multi_index/detail/duplicates_iterator.hpp>
...
public:
  ...
  typedef typename
    sofa::pbrpc::boost::reverse_iterator<iterator>                reverse_iterator;
  typedef typename
    sofa::pbrpc::boost::reverse_iterator<const_iterator>          const_reverse_iterator;
...
public:
  ...
  reverse_iterator
    rbegin()BOOST_NOEXCEPT{return sofa::pbrpc::boost::make_reverse_iterator(end());}
  const_reverse_iterator
    rbegin()const BOOST_NOEXCEPT{return sofa::pbrpc::boost::make_reverse_iterator(end());}
  reverse_iterator
    rend()BOOST_NOEXCEPT{return sofa::pbrpc::boost::make_reverse_iterator(begin());}
  const_reverse_iterator
    rend()const BOOST_NOEXCEPT{return sofa::pbrpc::boost::make_reverse_iterator(begin());}
  const_iterator
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  /* This forwarding function eases things for the sofa::pbrpc::boost::mem_fn construct
...
private:
  ...
  {
    lm.load(
      ::sofa::pbrpc::boost::bind(
        &ordered_index::rearranger,this,::sofa::pbrpc::boost::arg<1>(),::sofa::pbrpc::boost::arg<2>()),
      ar,version);
    super::load_(ar,version,lm);
  }
...
template<
  ...
  typename SuperMeta,typename TagList,typename Category
>
inline sofa::pbrpc::boost::mpl::true_* boost_foreach_is_noncopyable(
  sofa::pbrpc::boost::multi_index::detail::ordered_index<
    KeyFromValue,Compare,SuperMeta,TagList,Category>*&,
  sofa::pbrpc::boost::foreach::tag)
{
  return 0;
}
