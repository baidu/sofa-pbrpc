...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_VARTEMPL_SUPPORT_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_VARTEMPL_SUPPORT_HPP
 ...
 *
 * which fill the extra args with sofa::pbrpc::boost::multi_index::detail::noarg's.
 * sofa::pbrpc::boost::multi_index::detail::vartempl_placement_new works the opposite
...
#include <sofa/pbrpc/boost/preprocessor/arithmetic/add.hpp>
#include <sofa/pbrpc/boost/preprocessor/arithmetic/sub.hpp>
#include <sofa/pbrpc/boost/preprocessor/cat.hpp>
#include <sofa/pbrpc/boost/preprocessor/control/if.hpp>
#include <sofa/pbrpc/boost/preprocessor/facilities/empty.hpp>
#include <sofa/pbrpc/boost/preprocessor/facilities/intercept.hpp>
#include <sofa/pbrpc/boost/preprocessor/logical/and.hpp>
#include <sofa/pbrpc/boost/preprocessor/punctuation/comma.hpp>
#include <sofa/pbrpc/boost/preprocessor/punctuation/comma_if.hpp>
#include <sofa/pbrpc/boost/preprocessor/repetition/enum.hpp>
...
#include <sofa/pbrpc/boost/preprocessor/seq/elem.hpp>
...
sofa::pbrpc::boost::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  sofa::pbrpc::boost::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
