...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_INDEX_BASE_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_INDEX_BASE_HPP
...
#include <sofa/pbrpc/boost/move/utility.hpp>
#include <sofa/pbrpc/boost/mpl/vector.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/copy_map.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/node_type.hpp>
...
#include <sofa/pbrpc/boost/multi_index/detail/index_loader.hpp>
#include <sofa/pbrpc/boost/multi_index/detail/index_saver.hpp>
#endif
...
protected:
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,lvalue_tag)
  {
    ...
    BOOST_TRY{
      sofa::pbrpc::boost::detail::allocator::construct(&x->value(),v);
    }
    BOOST_CATCH(...){
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,rvalue_tag)
  {
    ...
    BOOST_TRY{
       ...
       * sofa::pbrpc::boost::detail::allocator::construct, but 
       * <sofa/pbrpc/boost/detail/allocator_utilities.hpp> is too old and venerable to
      ...
      new (&x->value()) value_type(sofa::pbrpc::boost::move(const_cast<value_type&>(v)));
    }
    BOOST_CATCH(...){
      final().deallocate_node(x);
      BOOST_RETHROW;
  ...
  {
    x->value()=sofa::pbrpc::boost::move(const_cast<value_type&>(v));
    return true;
  }
