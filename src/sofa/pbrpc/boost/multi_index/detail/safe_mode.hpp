...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_SAFE_MODE_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_SAFE_MODE_HPP
...
#include <sofa/pbrpc/boost/multi_index/detail/iter_adaptor.hpp>
#include <sofa/pbrpc/boost/multi_index/safe_mode_errors.hpp>
...
#include <sofa/pbrpc/boost/detail/lightweight_mutex.hpp>
#endif
...
inline void detach_equivalent_iterators(Iterator& it)
{
  if(it.valid()){
    {
#if defined(BOOST_HAS_THREADS)
      sofa::pbrpc::boost::detail::lightweight_mutex::scoped_lock lock(it.cont->mutex);
#endif
...
#if defined(BOOST_HAS_THREADS)
  sofa::pbrpc::boost::detail::lightweight_mutex mutex;
#endif
};
...
void safe_iterator_base::attach(safe_container_base* cont_)
{
  ...
  if(cont){
#if defined(BOOST_HAS_THREADS)
    sofa::pbrpc::boost::detail::lightweight_mutex::scoped_lock lock(cont->mutex);
#endif
...
private:
  friend class sofa::pbrpc::boost::multi_index::detail::iter_adaptor_access;
...
template<typename Iterator,typename Container>
struct version<
  sofa::pbrpc::boost::multi_index::safe_mode::safe_iterator<Iterator,Container>
>
{
  BOOST_STATIC_CONSTANT(
    int,value=sofa::pbrpc::boost::serialization::version<Iterator>::value);
};
} /* namespace serialization */
#endif
