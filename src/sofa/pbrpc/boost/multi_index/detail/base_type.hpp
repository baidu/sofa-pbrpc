...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_BASE_TYPE_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_BASE_TYPE_HPP
...
#include <sofa/pbrpc/boost/multi_index/detail/index_base.hpp>
