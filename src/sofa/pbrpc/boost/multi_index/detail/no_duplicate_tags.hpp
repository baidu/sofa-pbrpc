...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
...
#include <sofa/pbrpc/boost/mpl/set/set0.hpp>
