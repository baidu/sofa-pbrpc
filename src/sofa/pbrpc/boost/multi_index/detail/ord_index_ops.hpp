...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_ORD_INDEX_OPS_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_ORD_INDEX_OPS_HPP
...
#include <sofa/pbrpc/boost/multi_index/detail/promotes_arg.hpp>
#include <utility>
