...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_IS_INDEX_LIST_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_IS_INDEX_LIST_HPP
...
#include <sofa/pbrpc/boost/mpl/empty.hpp>
