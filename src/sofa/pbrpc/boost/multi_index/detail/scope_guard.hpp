...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_SCOPE_GUARD_HPP
...
{
    typedef typename sofa::pbrpc::boost::mpl::if_c<cond,T,null_guard>::type type;
};
