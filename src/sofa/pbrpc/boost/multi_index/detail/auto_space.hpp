...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_AUTO_SPACE_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_AUTO_SPACE_HPP
...
{
  typedef typename sofa::pbrpc::boost::detail::allocator::rebind_to<
    Allocator,T
