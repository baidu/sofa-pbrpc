...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
...
template<>struct uintptr_candidates<3> {typedef sofa::pbrpc::boost::ulong_long_type type;};
#else
