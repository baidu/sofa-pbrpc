...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_COPY_MAP_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_COPY_MAP_HPP
...
#include <sofa/pbrpc/boost/multi_index/detail/auto_space.hpp>
...
public:
  ...
  ~copy_map()
  {
    if(!released){
      for(std::size_t i=0;i<n;++i){
        sofa::pbrpc::boost::detail::allocator::destroy(&(spc.data()+i)->second->value());
  ...
  void clone(Node* node)
  {
    ...
    BOOST_TRY{
      sofa::pbrpc::boost::detail::allocator::construct(
