...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_IS_TRANSPARENT_HPP
...
#include <sofa/pbrpc/boost/type_traits/is_final.hpp>
