...
#ifndef SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
#define SOFA_PBRPC_BOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
...
/* Poor man's version of sofa::pbrpc::boost::iterator_adaptor. Used instead of the
