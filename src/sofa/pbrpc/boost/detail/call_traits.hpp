...
#ifndef SOFA_PBRPC_BOOST_DETAIL_CALL_TRAITS_HPP
#define SOFA_PBRPC_BOOST_DETAIL_CALL_TRAITS_HPP
...
public:
   ...
   typedef typename sofa::pbrpc::boost::detail::ct_imp<
      T,
...
#endif // SOFA_PBRPC_BOOST_DETAIL_CALL_TRAITS_HPP
