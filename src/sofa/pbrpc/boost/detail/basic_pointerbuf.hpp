...
#ifndef SOFA_PBRPC_BOOST_DETAIL_BASIC_POINTERBUF_HPP
#define SOFA_PBRPC_BOOST_DETAIL_BASIC_POINTERBUF_HPP
...
{
   typedef typename sofa::pbrpc::boost::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
#endif // SOFA_PBRPC_BOOST_DETAIL_BASIC_POINTERBUF_HPP
