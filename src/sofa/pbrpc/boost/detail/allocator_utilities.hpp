...
#ifndef SOFA_PBRPC_BOOST_DETAIL_ALLOCATOR_UTILITIES_HPP
#define SOFA_PBRPC_BOOST_DETAIL_ALLOCATOR_UTILITIES_HPP
...
} /* namespace sofa::pbrpc::boost::detail::allocator */
