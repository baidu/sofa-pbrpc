...
#ifndef SOFA_PBRPC_BOOST_LEXICAL_CAST_BAD_LEXICAL_CAST_HPP
#define SOFA_PBRPC_BOOST_LEXICAL_CAST_BAD_LEXICAL_CAST_HPP
...
namespace boost
{
    ...
    namespace conversion { namespace detail {
        ...
        inline void throw_bad_cast() {
            sofa::pbrpc::boost::throw_exception(bad_lexical_cast());
        }
#else
        template <class S, class T>
        inline void throw_bad_cast() {
            sofa::pbrpc::boost::throw_exception(bad_lexical_cast(typeid(S), typeid(T)));
        }
#endif
...
#endif // SOFA_PBRPC_BOOST_LEXICAL_CAST_BAD_LEXICAL_CAST_HPP
