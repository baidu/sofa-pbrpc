...
#ifndef SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_LCAST_CHAR_CONSTANTS_HPP
#define SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_LCAST_CHAR_CONSTANTS_HPP
...
#endif // SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_LCAST_CHAR_CONSTANTS_HPP
