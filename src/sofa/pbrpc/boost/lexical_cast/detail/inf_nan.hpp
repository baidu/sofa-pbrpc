...
#ifndef SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_INF_NAN_HPP
#define SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_INF_NAN_HPP
...
#include <sofa/pbrpc/boost/math/special_functions/sign.hpp>
#include <sofa/pbrpc/boost/math/special_functions/fpclassify.hpp>
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = (sofa::pbrpc::boost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
             ...
             )
            {
                ...
                else value = (sofa::pbrpc::boost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity) BOOST_NOEXCEPT
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ((sofa::pbrpc::boost::math::isnan)(value)) {
                if ((sofa::pbrpc::boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ((sofa::pbrpc::boost::math::isinf)(value)) {
                if ((sofa::pbrpc::boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
...
#endif // SOFA_PBRPC_BOOST_LEXICAL_CAST_DETAIL_INF_NAN_HPP
