...
#ifndef SOFA_PBRPC_BOOST_MPL_FIND_IF_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_FIND_IF_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/mpl/aux_/find_if_pred.hpp>
#include <sofa/pbrpc/boost/mpl/arg.hpp>
#include <sofa/pbrpc/boost/mpl/iter_fold_if.hpp>
...
#endif // SOFA_PBRPC_BOOST_MPL_FIND_IF_HPP_INCLUDED
