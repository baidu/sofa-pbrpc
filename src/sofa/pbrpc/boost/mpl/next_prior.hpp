...
#ifndef SOFA_PBRPC_BOOST_MPL_NEXT_PRIOR_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_NEXT_PRIOR_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_MPL_NEXT_PRIOR_HPP_INCLUDED
