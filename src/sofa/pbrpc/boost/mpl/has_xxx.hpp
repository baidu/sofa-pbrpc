...
#ifndef SOFA_PBRPC_BOOST_MPL_HAS_XXX_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_HAS_XXX_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/mpl/aux_/config/has_xxx.hpp>
#include <sofa/pbrpc/boost/mpl/aux_/config/msvc_typename.hpp>
...
#include <sofa/pbrpc/boost/preprocessor/array/elem.hpp>
...
#include <sofa/pbrpc/boost/preprocessor/repetition/enum_trailing_params.hpp>
...
template< typename T, typename name = ::sofa::pbrpc::boost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static sofa::pbrpc::boost::mpl::aux::no_tag \
    test(void(*)(::sofa::pbrpc::boost::mpl::aux::has_xxx_tag)); \
    \
    static sofa::pbrpc::boost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(sofa::pbrpc::boost::mpl::aux::no_tag) \
        ); \
    typedef sofa::pbrpc::boost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = sofa::pbrpc::boost::mpl::bool_<default_> > \
struct trait \
    : sofa::pbrpc::boost::mpl::if_c< \
          sofa::pbrpc::boost::mpl::aux::msvc_is_incomplete<T>::value \
        , sofa::pbrpc::boost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef sofa::pbrpc::boost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( sofa::pbrpc::boost::mpl::aux::type_wrapper<U> const volatile * \
                           , sofa::pbrpc::boost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef sofa::pbrpc::boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = sofa::pbrpc::boost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, sofa::pbrpc::boost::is_class< T >::value >::value) );     \
    typedef sofa::pbrpc::boost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static sofa::pbrpc::boost::mpl::aux::yes_tag test( \
              sofa::pbrpc::boost::mpl::aux::type_wrapper<U> const volatile* \
            , sofa::pbrpc::boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static sofa::pbrpc::boost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef sofa::pbrpc::boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(sofa::pbrpc::boost::mpl::aux::yes_tag) \
        ); \
    typedef sofa::pbrpc::boost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static sofa::pbrpc::boost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            sofa::pbrpc::boost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< sofa::pbrpc::boost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(sofa::pbrpc::boost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = sofa::pbrpc::boost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = sofa::pbrpc::boost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
...
#endif // SOFA_PBRPC_BOOST_MPL_HAS_XXX_HPP_INCLUDED
