...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_MSVC_IS_CLASS_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_MSVC_IS_CLASS_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_MSVC_IS_CLASS_HPP_INCLUDED
