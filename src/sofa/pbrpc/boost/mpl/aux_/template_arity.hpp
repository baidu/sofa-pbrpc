...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_TEMPLATE_ARITY_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_TEMPLATE_ARITY_HPP_INCLUDED
...
#   include <sofa/pbrpc/boost/mpl/aux_/template_arity_fwd.hpp>
...
#   endif
#   else
#       include <sofa/pbrpc/boost/mpl/aux_/has_rebind.hpp>
#   endif
#endif
...
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/range.hpp>
...
#   define BOOST_PP_FILENAME_1 <sofa/pbrpc/boost/mpl/aux_/template_arity.hpp>
...
{
    BOOST_STATIC_CONSTANT(int, value = 
          sizeof(::sofa::pbrpc::boost::mpl::aux::arity_helper(type_wrapper<F>(),arity_tag<N>())) - 1
        );
};
...
template< typename F >
struct template_arity
    : template_arity_impl< ::sofa::pbrpc::boost::mpl::aux::has_rebind<F>::value >
        ::template result_<F>
{
};
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_TEMPLATE_ARITY_HPP_INCLUDED
