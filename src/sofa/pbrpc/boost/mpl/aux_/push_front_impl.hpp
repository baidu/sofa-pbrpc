...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
...
struct push_front_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        BOOST_MPL_ASSERT_MSG(
              ( sofa::pbrpc::boost::is_same< T, has_push_front_arg >::value )
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
