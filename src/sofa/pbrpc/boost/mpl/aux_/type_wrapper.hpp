...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
