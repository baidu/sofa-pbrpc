...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/mpl/push_back_fwd.hpp>
...
struct push_back_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        BOOST_MPL_ASSERT_MSG(
              ( sofa::pbrpc::boost::is_same< T, has_push_back_arg >::value )
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
