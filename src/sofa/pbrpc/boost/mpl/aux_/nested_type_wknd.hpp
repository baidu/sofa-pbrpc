...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_NESTED_TYPE_WKND_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_NESTED_TYPE_WKND_HPP_INCLUDED
...
#else
#   define BOOST_MPL_AUX_NESTED_TYPE_WKND(T) \
    ::sofa::pbrpc::boost::mpl::aux::nested_type_wknd<T> \
/**/
#endif
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_NESTED_TYPE_WKND_HPP_INCLUDED
