...
#ifndef SOFA_PBRPC_BOOST_MPL_AUX_IS_MSVC_ETI_ARG_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_AUX_IS_MSVC_ETI_ARG_HPP_INCLUDED
...
#endif // SOFA_PBRPC_BOOST_MPL_AUX_IS_MSVC_ETI_ARG_HPP_INCLUDED
