...
#ifndef SOFA_PBRPC_BOOST_MPL_BIND_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_BIND_HPP_INCLUDED
...
#   include <sofa/pbrpc/boost/mpl/bind_fwd.hpp>
...
#   include <sofa/pbrpc/boost/mpl/apply_wrap.hpp>
#   include <sofa/pbrpc/boost/mpl/limits/arity.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/na.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/arity_spec.hpp>
...
#include <sofa/pbrpc/boost/mpl/aux_/config/bind.hpp>
...
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/repeat.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/enum.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/preprocessor/add.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/config/ctps.hpp>
#   include <sofa/pbrpc/boost/mpl/aux_/config/ttp.hpp>
...
template< typename T > struct is_bind_template
    : is_bind_template_impl< ::sofa::pbrpc::boost::detail::is_reference_impl<T>::value >
        ::template result_<T>
{
};
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <sofa/pbrpc/boost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <sofa/pbrpc/boost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <sofa/pbrpc/boost/mpl/aux_/count_args.hpp>
}
...
#endif // SOFA_PBRPC_BOOST_MPL_BIND_HPP_INCLUDED
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <sofa/pbrpc/boost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
