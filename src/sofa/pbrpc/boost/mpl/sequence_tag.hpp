...
#ifndef SOFA_PBRPC_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
...
#include <sofa/pbrpc/boost/mpl/sequence_tag_fwd.hpp>
#include <sofa/pbrpc/boost/mpl/aux_/has_tag.hpp>
#include <sofa/pbrpc/boost/mpl/aux_/has_begin.hpp>
#include <sofa/pbrpc/boost/mpl/aux_/na_spec.hpp>
#include <sofa/pbrpc/boost/mpl/aux_/is_msvc_eti_arg.hpp>
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::sofa::pbrpc::boost::mpl::aux::has_tag<Sequence>::value
        , ::sofa::pbrpc::boost::mpl::aux::has_begin<Sequence>::value
...
#endif // SOFA_PBRPC_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
