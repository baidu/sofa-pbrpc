...
#ifndef SOFA_PBRPC_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP 
#define SOFA_PBRPC_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
...
#include <sofa/pbrpc/boost/algorithm/string/detail/sequence.hpp>
...
//  storage handling routines -----------------------------------------------//
            ...
            inline void copy_to_storage(
                ...
                const WhatT& What )
            {
                Storage.insert( Storage.end(), ::sofa::pbrpc::boost::begin(What), ::sofa::pbrpc::boost::end(What) );
            }
...
//  process segment routine -----------------------------------------------//
            ...
            struct process_segment_helper
            {
                    ...
                    ForwardIteratorT SegmentEnd )
                {
                    ...
                    ForwardIteratorT It=::sofa::pbrpc::boost::algorithm::detail::move_from_storage( Storage, InsertIt, SegmentBegin );
            ...
            struct process_segment_helper< true >
            {
...

                {
                    ...
                    ::sofa::pbrpc::boost::algorithm::detail::replace( Input, InsertIt, SegmentBegin, Storage );
                    // Empty the storage
                    Storage.clear();
...
#endif  // SOFA_PBRPC_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
