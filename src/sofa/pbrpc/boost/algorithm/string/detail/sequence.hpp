...
#ifndef SOFA_PBRPC_BOOST_STRING_DETAIL_SEQUENCE_HPP
#define SOFA_PBRPC_BOOST_STRING_DETAIL_SEQUENCE_HPP

#include <sofa/pbrpc/boost/algorithm/string/config.hpp>
#include <sofa/pbrpc/boost/mpl/bool.hpp>
#include <sofa/pbrpc/boost/mpl/logical.hpp>
#include <sofa/pbrpc/boost/range/begin.hpp>
#include <sofa/pbrpc/boost/range/end.hpp>

#include <sofa/pbrpc/boost/algorithm/string/sequence_traits.hpp>
...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::sofa::pbrpc::boost::algorithm::detail::insert( Input, At, ::sofa::pbrpc::boost::begin(Insert), ::sofa::pbrpc::boost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::sofa::pbrpc::boost::algorithm::detail::replace( Input, From, To, ::sofa::pbrpc::boost::begin(Insert), ::sofa::pbrpc::boost::end(Insert) );
                }
                else
                {
                    ::sofa::pbrpc::boost::algorithm::detail::insert( Input, From, ::sofa::pbrpc::boost::begin(Insert), ::sofa::pbrpc::boost::end(Insert) );
                }
            }
...
#endif  // SOFA_PBRPC_BOOST_STRING_DETAIL_SEQUENCE_HPP
