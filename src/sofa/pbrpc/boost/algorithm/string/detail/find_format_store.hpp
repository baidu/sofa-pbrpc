...
#ifndef SOFA_PBRPC_BOOST_STRING_FIND_FORMAT_STORE_DETAIL_HPP
#define SOFA_PBRPC_BOOST_STRING_FIND_FORMAT_STORE_DETAIL_HPP
...
#endif  // SOFA_PBRPC_BOOST_STRING_FIND_FORMAT_STORE_DETAIL_HPP
