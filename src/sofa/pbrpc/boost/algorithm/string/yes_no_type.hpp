...
#ifndef SOFA_PBRPC_BOOST_STRING_YES_NO_TYPE_DETAIL_HPP
#define SOFA_PBRPC_BOOST_STRING_YES_NO_TYPE_DETAIL_HPP
...
#endif  // SOFA_PBRPC_BOOST_STRING_YES_NO_TYPE_DETAIL_HPP
