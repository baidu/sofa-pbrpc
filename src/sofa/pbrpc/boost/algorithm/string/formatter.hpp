...
#ifndef SOFA_PBRPC_BOOST_STRING_FORMATTER_HPP
#define SOFA_PBRPC_BOOST_STRING_FORMATTER_HPP
...
#include <sofa/pbrpc/boost/algorithm/string/detail/formatter.hpp>
        ...
        */
        ...
        const_formatter(const RangeT& Format)
        {
            return detail::const_formatF<
                iterator_range<
                    BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> >(::sofa::pbrpc::boost::as_literal(Format));
        }
...
#endif  // SOFA_PBRPC_BOOST_STRING_FORMATTER_HPP
