...
#ifndef SOFA_PBRPC_BOOST_STRING_REPLACE_HPP
#define SOFA_PBRPC_BOOST_STRING_REPLACE_HPP
...
#include <sofa/pbrpc/boost/algorithm/string/find_format.hpp>
#include <sofa/pbrpc/boost/algorithm/string/finder.hpp>
#include <sofa/pbrpc/boost/algorithm/string/formatter.hpp>
#include <sofa/pbrpc/boost/algorithm/string/compare.hpp>
...
//  replace_range --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::range_finder(SearchRange),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format));
        }
        ...
        */
        ...
        inline void replace_range( 
            ...
            const RangeT& Format)
        {
            ::sofa::pbrpc::boost::algorithm::find_format(
                Input,
                ::sofa::pbrpc::boost::algorithm::range_finder(SearchRange),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::first_finder(Search),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::last_finder(Search),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::nth_finder(Search, Nth),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
...
//  replace_all --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_copy(
            ...
            const Range3T& Format )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_all_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::first_finder(Search),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        ...
        */
        ...
        inline void replace_all( 
            ...
            const Range2T& Format )
        {
            ::sofa::pbrpc::boost::algorithm::find_format_all( 
                Input, 
                ::sofa::pbrpc::boost::algorithm::first_finder(Search),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::head_finder(N),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::sofa::pbrpc::boost::algorithm::find_format_copy(
                Output,
                Input,
                ::sofa::pbrpc::boost::algorithm::tail_finder(N),
                ::sofa::pbrpc::boost::algorithm::const_formatter(Format) );
        }
...
#endif  // SOFA_PBRPC_BOOST_STRING_REPLACE_HPP
