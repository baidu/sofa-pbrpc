...
#ifndef SOFA_PBRPC_BOOST_STRING_CONCEPT_HPP
#define SOFA_PBRPC_BOOST_STRING_CONCEPT_HPP
    ...
    namespace algorithm {
        ...
        */
        ...
        public:
            ...
            {
                // Operation
                ::sofa::pbrpc::boost::begin((*pFo)( (*pF)(i,i) ));
                ::sofa::pbrpc::boost::end((*pFo)( (*pF)(i,i) ));
            }
        private:
            IteratorT i;
            FinderT* pF;
...
#endif  // SOFA_PBRPC_BOOST_STRING_CONCEPT_HPP
