...
#ifndef SOFA_PBRPC_BOOST_MATH_TOOLS_CONFIG_HPP
#define SOFA_PBRPC_BOOST_MATH_TOOLS_CONFIG_HPP
...
#include <sofa/pbrpc/boost/cstdint.hpp> // for sofa::pbrpc::sofa/pbrpc/boost::uintmax_t
...
#include <sofa/pbrpc/boost/math/tools/user.hpp>
...
#  include "sofa/pbrpc/boost/non_type.hpp"

#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         sofa::pbrpc::boost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    sofa::pbrpc::boost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  sofa::pbrpc::boost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  sofa::pbrpc::boost::non_type<t, v>*
...
{
   static const bool value = sofa::pbrpc::boost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
//
   ...
   #include <sofa/pbrpc/boost/detail/fenv.hpp>
...
#    define BOOST_FPU_EXCEPTION_GUARD sofa::pbrpc::boost::math::detail::fpu_guard local_guard_object;
...
#endif // SOFA_PBRPC_BOOST_MATH_TOOLS_CONFIG_HPP
