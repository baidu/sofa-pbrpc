...
#ifndef SOFA_PBRPC_BOOST_MATH_FPCLASSIFY_HPP
#define SOFA_PBRPC_BOOST_MATH_FPCLASSIFY_HPP
...
#include <math.h>
#include <sofa/pbrpc/boost/config/no_tr1/cmath.hpp>
#include <sofa/pbrpc/boost/limits.hpp>
#include <sofa/pbrpc/boost/math/tools/real_cast.hpp>
#include <sofa/pbrpc/boost/type_traits/is_floating_point.hpp>
#include <sofa/pbrpc/boost/math/special_functions/math_fwd.hpp>
#include <sofa/pbrpc/boost/math/special_functions/detail/fp_traits.hpp>
/*!
  \file fpclassify.hpp
...
//
// This must not be located in any namespace under sofa::pbrpc::boost::math
...
template <class T>
inline bool is_nan_helper(T t, const sofa::pbrpc::boost::true_type&)
{
#ifdef isnan
   return isnan(t);
...
template <class T>
inline bool is_nan_helper(T, const sofa::pbrpc::boost::false_type&)
{
   return false;
}
...
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(T t, const generic_tag<true>&)
{
   ...
   if(::sofa::pbrpc::boost::math_detail::is_nan_helper(t, ::sofa::pbrpc::boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(isnan)
   if(sofa::pbrpc::boost::math_detail::is_nan_helper(t, ::sofa::pbrpc::boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(_MSC_VER) || defined(__BORLANDC__)
   if(::_isnan(sofa::pbrpc::boost::math::tools::real_cast<double>(t)))
      return FP_NAN;
#endif
...
{
   return sofa::pbrpc::boost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return sofa::pbrpc::boost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   // typedef typename sofa::pbrpc::boost::is_floating_point<T>::type fp_tag;
   typedef typename tools::promote_args_permissive<T>::type value_type;
...
{ //!< \brief return true if floating-point type t is finite.
   typedef detail::fp_traits<long double>::type traits;
   typedef traits::method method;
   //typedef sofa::pbrpc::boost::is_floating_point<long double>::type fp_tag;
   typedef long double value_type;
   return detail::isfinite_impl(static_cast<value_type>(x), method());
}
#endif
...
{
   return sofa::pbrpc::boost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return sofa::pbrpc::boost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::sofa::pbrpc::boost::math_detail::is_nan_helper(t, sofa::pbrpc::boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::sofa::pbrpc::boost::math_detail::is_nan_helper(t, sofa::pbrpc::boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::sofa::pbrpc::boost::math_detail::is_nan_helper(t, sofa::pbrpc::boost::true_type()); }
...
#endif // SOFA_PBRPC_BOOST_MATH_FPCLASSIFY_HPP
