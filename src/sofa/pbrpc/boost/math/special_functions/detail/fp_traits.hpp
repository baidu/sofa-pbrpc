...
#ifndef SOFA_PBRPC_BOOST_MATH_FP_TRAITS_HPP
#define SOFA_PBRPC_BOOST_MATH_FP_TRAITS_HPP
...
#include <sofa/pbrpc/boost/detail/endian.hpp>
...
{
    typedef BOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::sofa::pbrpc::boost::is_floating_point<T>::value>::type precision;
