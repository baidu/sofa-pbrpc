...
#ifndef SOFA_PBRPC_BOOST_MATH_TOOLS_SIGN_HPP
#define SOFA_PBRPC_BOOST_MATH_TOOLS_SIGN_HPP
...
namespace detail {
  ...
  // signbit
    ...
    {
       return (sofa::pbrpc::boost::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = sofa::pbrpc::boost::math::changesign(pd[0]);
       pd[1] = sofa::pbrpc::boost::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (sofa::pbrpc::boost::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (sofa::pbrpc::boost::math::signbit)(static_cast<result_type>(x)) != (sofa::pbrpc::boost::math::signbit)(static_cast<result_type>(y)) 
      ? (sofa::pbrpc::boost::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
...
#endif // SOFA_PBRPC_BOOST_MATH_TOOLS_SIGN_HPP
