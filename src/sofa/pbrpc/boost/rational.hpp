...
#ifndef SOFA_PBRPC_BOOST_RATIONAL_HPP
#define SOFA_PBRPC_BOOST_RATIONAL_HPP

#include <sofa/pbrpc/boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <sofa/pbrpc/boost/operators.hpp>   // for sofa::pbrpc::sofa/pbrpc/boost::addable etc
#include <cstdlib>               // for std::abs
#include <sofa/pbrpc/boost/call_traits.hpp> // for sofa::pbrpc::sofa/pbrpc/boost::call_traits
#include <sofa/pbrpc/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <sofa/pbrpc/boost/assert.hpp>      // for BOOST_ASSERT
#include <sofa/pbrpc/boost/integer/common_factor_rt.hpp> // for sofa::pbrpc::sofa/pbrpc/boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <sofa/pbrpc/boost/static_assert.hpp>  // for BOOST_STATIC_ASSERT
    ...
    > > > > > > > > > > > > > > > >
{
    ...
    // Helper types
    typedef typename sofa::pbrpc::boost::call_traits<IntType>::param_type param_type;
...
#endif  // SOFA_PBRPC_BOOST_RATIONAL_HPP
