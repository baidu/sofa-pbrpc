...
#ifndef SOFA_PBRPC_BOOST_MOVE_CORE_HPP
#define SOFA_PBRPC_BOOST_MOVE_CORE_HPP
...
namespace pbrpc {
   ...
   template <class T>
   class rv
      : public ::sofa::pbrpc::boost::move_detail::if_c
         < ::sofa::pbrpc::boost::move_detail::is_class<T>::value
         , T
         , ::sofa::pbrpc::boost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::sofa::pbrpc::boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::sofa::pbrpc::boost::move_detail::has_move_emulation_enabled_impl<T>
   {};
   ...
   #define BOOST_RV_REF(TYPE)\
      ::sofa::pbrpc::boost::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::sofa::pbrpc::boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::sofa::pbrpc::boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::sofa::pbrpc::boost::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::sofa::pbrpc::boost::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::sofa::pbrpc::boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::sofa::pbrpc::boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
...
namespace pbrpc {
   ...
   inline typename ::sofa::pbrpc::boost::move_detail::enable_if_c
      <  ::sofa::pbrpc::boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::sofa::pbrpc::boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   inline typename ::sofa::pbrpc::boost::move_detail::enable_if_c
      < !::sofa::pbrpc::boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::sofa::pbrpc::boost::has_move_emulation_enabled<T>::value
      , ::sofa::pbrpc::boost::rv<T>&>::type
         move_return(T& x) BOOST_NOEXCEPT
   {
      return *static_cast< ::sofa::pbrpc::boost::rv<T>* >(::sofa::pbrpc::boost::move_detail::addressof(x));
   }
   ...
   inline typename ::sofa::pbrpc::boost::move_detail::enable_if_c
      < !::sofa::pbrpc::boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::sofa::pbrpc::boost::has_move_emulation_enabled<T>::value
      , ::sofa::pbrpc::boost::rv<T>&>::type
         move_return(::sofa::pbrpc::boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      sofa::pbrpc::boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::sofa::pbrpc::boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      operator ::sofa::pbrpc::boost::rv<TYPE>&() \
      {  return *static_cast< ::sofa::pbrpc::boost::rv<TYPE>* >(this);  }\
      operator const ::sofa::pbrpc::boost::rv<TYPE>&() const \
      {  return *static_cast<const ::sofa::pbrpc::boost::rv<TYPE>* >(this);  }\
      private:\
   //
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::sofa::pbrpc::boost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::sofa::pbrpc::boost::rv<TYPE>&() \
      {  return *static_cast< ::sofa::pbrpc::boost::rv<TYPE>* >(this);  }\
      operator const ::sofa::pbrpc::boost::rv<TYPE>&() const \
...
namespace pbrpc {
   ...
   template< class T>
   struct forward_type< sofa::pbrpc::boost::rv<T> >
   { typedef T type; };
...
namespace pbrpc {
   ...
   //!cast to the base type before calling `::sofa::pbrpc::boost::move()` due to rvalue reference limitations.
   //!
...
#endif //#ifndef SOFA_PBRPC_BOOST_MOVE_CORE_HPP
