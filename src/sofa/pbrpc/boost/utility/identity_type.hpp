...
#ifndef SOFA_PBRPC_BOOST_IDENTITY_TYPE_HPP_
#define SOFA_PBRPC_BOOST_IDENTITY_TYPE_HPP_
...
#define BOOST_IDENTITY_TYPE(parenthesized_type) \
    ...
    sofa::pbrpc::boost::function_traits< void parenthesized_type >::arg1_type
