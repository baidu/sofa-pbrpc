#ifndef SOFA_PBRPC_DATE_TIME_LOCAL_TIME_ADJUSTOR_HPP__
#define SOFA_PBRPC_DATE_TIME_LOCAL_TIME_ADJUSTOR_HPP__
...
#include <sofa/pbrpc/boost/date_time/time_defs.hpp> // sofa::pbrpc::boost::date_time::dst_flags
#include <sofa/pbrpc/boost/date_time/special_defs.hpp> // not_a_date_time
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        sofa::pbrpc::boost::throw_exception(std::out_of_range("Unreachable case"));
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate) 
      {
        ...
        sofa::pbrpc::boost::throw_exception(std::out_of_range("Time label invalid"));
        BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
