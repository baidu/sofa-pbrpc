#ifndef SOFA_PBRPC_DATE_TIME_TIME_SYSTEM_COUNTED_HPP
#define SOFA_PBRPC_DATE_TIME_TIME_SYSTEM_COUNTED_HPP
...
namespace date_time {
  ...
  struct counted_time_rep
  {
    ...
    {
      /* resolution_traits::as_number returns a sofa::pbrpc::boost::int64_t & 
       * frac_sec_per_day is also a sofa::pbrpc::boost::int64_t so, naturally, 
       * the division operation returns a sofa::pbrpc::boost::int64_t. 
