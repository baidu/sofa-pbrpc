#ifndef SOFA_PBRPC_DATE_TIME_DATE_DURATION__
#define SOFA_PBRPC_DATE_TIME_DATE_DURATION__
...
namespace date_time {
  ...
  class date_duration : private
              sofa::pbrpc::boost::less_than_comparable1< date_duration< duration_rep_traits >
            , sofa::pbrpc::boost::equality_comparable1< date_duration< duration_rep_traits >
            , sofa::pbrpc::boost::addable1< date_duration< duration_rep_traits >
            , sofa::pbrpc::boost::subtractable1< date_duration< duration_rep_traits >
            , sofa::pbrpc::boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef sofa::pbrpc::boost::date_time::int_adapter<long> impl_type;
