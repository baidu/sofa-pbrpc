#ifndef SOFA_PBRPC_DATE_TIME_COMPILER_CONFIG_HPP___
#define SOFA_PBRPC_DATE_TIME_COMPILER_CONFIG_HPP___
...
#include <sofa/pbrpc/boost/date_time/locale_config.hpp> //set up locale configurations
...
// uninitialized variables after calling to sofa::pbrpc::boost::throw_exception.
...
//
#include <sofa/pbrpc/boost/config/auto_link.hpp>
