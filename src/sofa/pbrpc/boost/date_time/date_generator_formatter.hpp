#ifndef SOFA_PBRPC__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
#define SOFA_PBRPC__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
...
#endif // SOFA_PBRPC__DATE_TIME_DATE_GENERATOR_FORMATTER__HPP___
