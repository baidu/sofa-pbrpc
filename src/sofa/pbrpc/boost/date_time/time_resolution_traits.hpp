#ifndef SOFA_PBRPC_DATE_TIME_TIME_RESOLUTION_TRAITS_HPP
#define SOFA_PBRPC_DATE_TIME_TIME_RESOLUTION_TRAITS_HPP
...
#include <sofa/pbrpc/boost/date_time/time_defs.hpp>
#include <sofa/pbrpc/boost/date_time/int_adapter.hpp>
...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef sofa::pbrpc::boost::int32_t int_type;
    typedef sofa::pbrpc::boost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef sofa::pbrpc::boost::int32_t int_type;
    typedef sofa::pbrpc::boost::date_time::int_adapter<sofa::pbrpc::boost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef sofa::pbrpc::boost::int64_t int_type;
    typedef sofa::pbrpc::boost::int64_t impl_type;
    static int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef sofa::pbrpc::boost::int64_t int_type;
    typedef sofa::pbrpc::boost::date_time::int_adapter<sofa::pbrpc::boost::int64_t> impl_type;
    static int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return true;}
  };
  ...
  template<typename frac_sec_type,
           ...
           sofa::pbrpc::boost::int64_t resolution_adjust,
#else
           typename frac_sec_type::int_type resolution_adjust,
#endif
           unsigned short frac_digits,
           typename var_type = sofa::pbrpc::boost::int32_t >
...
#if (defined(BOOST_MSVC) && (_MSC_VER < 1300))
    BOOST_STATIC_CONSTANT(sofa::pbrpc::boost::int64_t, ticks_per_second = resolution_adjust);
#else
