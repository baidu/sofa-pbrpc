#ifndef SOFA_PBRPC_DATE_TIME_PERIOD_HPP___
#define SOFA_PBRPC_DATE_TIME_PERIOD_HPP___
...
namespace date_time {
  ...
  class period : private
      sofa::pbrpc::boost::less_than_comparable<period<point_rep, duration_rep> 
    , sofa::pbrpc::boost::equality_comparable< period<point_rep, duration_rep> 
    > >
  {
  public:
