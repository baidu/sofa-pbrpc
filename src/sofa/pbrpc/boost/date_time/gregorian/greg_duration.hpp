#ifndef SOFA_PBRPC_GREG_DURATION_HPP___
#define SOFA_PBRPC_GREG_DURATION_HPP___
...
#include <sofa/pbrpc/boost/date_time/date_duration.hpp>
...
namespace gregorian {
  ...
  typedef sofa::pbrpc::boost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public sofa::pbrpc::boost::date_time::date_duration< date_duration_rep >
  {
    typedef sofa::pbrpc::boost::date_time::date_duration< date_duration_rep > base_type;
...
#include <sofa/pbrpc/boost/date_time/date_duration_types.hpp>
#endif
