#ifndef SOFA_PBRPC__GREGORIAN__CONVERSION_HPP___
#define SOFA_PBRPC__GREGORIAN__CONVERSION_HPP___
...
namespace gregorian {
  ...
  std::tm to_tm(const date& d)
  {
    if (d.is_special())
    {
        ...
        sofa::pbrpc::boost::throw_exception(std::out_of_range(s));
    }

    std::tm datetm;
    std::memset(&datetm, 0, sizeof(datetm));
    sofa::pbrpc::boost::gregorian::date::ymd_type ymd = d.year_month_day();
