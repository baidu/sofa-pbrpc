#ifndef SOFA_PBRPC_GREG_MONTH_HPP___
#define SOFA_PBRPC_GREG_MONTH_HPP___
...
#include "sofa/pbrpc/boost/date_time/constrained_value.hpp"
...
namespace gregorian {
  ...
  public:
    ...
    typedef sofa::pbrpc::boost::shared_ptr<month_map_type> month_map_ptr_type;
