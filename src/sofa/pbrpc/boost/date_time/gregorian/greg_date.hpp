#ifndef SOFA_PBRPC_GREG_DATE_HPP___
#define SOFA_PBRPC_GREG_DATE_HPP___
   ...
   public:
      ...
      : date_time::date<date, gregorian_calendar, date_duration>(y, m, d)
    {
      if (gregorian_calendar::end_of_month_day(y, m) < d) {
        sofa::pbrpc::boost::throw_exception(bad_day_of_month(std::string("Day of month is not valid for year")));
      }
    }
