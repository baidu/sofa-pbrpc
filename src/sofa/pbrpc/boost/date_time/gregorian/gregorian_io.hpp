#ifndef SOFA_PBRPC_DATE_TIME_GREGORIAN_IO_HPP__
#define SOFA_PBRPC_DATE_TIME_GREGORIAN_IO_HPP__
...
#include <sofa/pbrpc/boost/io/ios_state.hpp>
#include <sofa/pbrpc/boost/date_time/date_facet.hpp>
#include <sofa/pbrpc/boost/date_time/period_parser.hpp>
#include <sofa/pbrpc/boost/date_time/period_formatter.hpp>
#include <sofa/pbrpc/boost/date_time/special_values_parser.hpp>
#include <sofa/pbrpc/boost/date_time/special_values_formatter.hpp>
#include <sofa/pbrpc/boost/date_time/gregorian/gregorian_types.hpp>
#include <sofa/pbrpc/boost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets
...
namespace gregorian {
  ...
  typedef sofa::pbrpc::boost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef sofa::pbrpc::boost::date_time::period_formatter<char>    period_formatter;
  
  typedef sofa::pbrpc::boost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef sofa::pbrpc::boost::date_time::date_facet<date,char>    date_facet;

  typedef sofa::pbrpc::boost::date_time::period_parser<date,char>       period_parser;
  typedef sofa::pbrpc::boost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef sofa::pbrpc::boost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef sofa::pbrpc::boost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef sofa::pbrpc::boost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef sofa::pbrpc::boost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef sofa::pbrpc::boost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef sofa::pbrpc::boost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::date& d) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::date_duration& dd) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::date_period& dp) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::greg_month& gm) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::greg_weekday& gw) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::partial_date& pd) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::nth_day_of_the_week_in_month& nkd) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::first_day_of_the_week_in_month& fkd) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::last_day_of_the_week_in_month& lkd) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::first_day_of_the_week_after& fda) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const sofa::pbrpc::boost::gregorian::first_day_of_the_week_before& fdb) {
    sofa::pbrpc::boost::io::ios_flags_saver iflags(os);
    typedef sofa::pbrpc::boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
...
#endif // SOFA_PBRPC_DATE_TIME_GREGORIAN_IO_HPP__
