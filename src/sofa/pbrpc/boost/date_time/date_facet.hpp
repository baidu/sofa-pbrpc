#ifndef SOFA_PBRPC__DATE_TIME_DATE_FACET__HPP___
#define SOFA_PBRPC__DATE_TIME_DATE_FACET__HPP___
...
#include <sofa/pbrpc/boost/date_time/period.hpp>
...
#include <sofa/pbrpc/boost/date_time/date_generator_formatter.hpp>
#include <sofa/pbrpc/boost/date_time/date_generator_parser.hpp>
#include <sofa/pbrpc/boost/date_time/format_date_parser.hpp>
...
namespace boost { namespace date_time {
  ...
  public:
    ...
    typedef sofa::pbrpc::boost::date_time::period<date_type,duration_type> period_type;
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef sofa::pbrpc::boost::date_time::period_formatter<CharT>  period_formatter_type;
    typedef sofa::pbrpc::boost::date_time::special_values_formatter<CharT>  special_values_formatter_type;
  ...
  protected:
    virtual OutItrT do_put_special(OutItrT next,
                                   std::ios_base& /*a_ios*/,
                                   char_type /*fill_char*/,
                                   const sofa::pbrpc::boost::date_time::special_values sv) const
    {
                              ...
                              string_type a_format) const
    {
      ...
      if (m_weekday_long_names.size()) {
        sofa::pbrpc::boost::algorithm::replace_all(a_format,
                                      long_weekday_format,
  ...
  public:
    ...
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef sofa::pbrpc::boost::date_time::period_parser<date_type, CharT>  period_parser_type;
    typedef sofa::pbrpc::boost::date_time::special_values_parser<date_type,CharT> special_values_parser_type;
    typedef std::vector<std::basic_string<CharT> > input_collection_type;
               ...
               duration_type& dd) const
    {
      ...
      if(err & std::ios_base::failbit){
        ...
        if(mr.current_match == match_results::PARSE_ERROR) {
          sofa::pbrpc::boost::throw_exception(std::ios_base::failure("Parse failed. No match found for '" + mr.cache + "'"));
