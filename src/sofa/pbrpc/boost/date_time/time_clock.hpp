#ifndef SOFA_PBRPC_DATE_TIME_TIME_CLOCK_HPP___
#define SOFA_PBRPC_DATE_TIME_TIME_CLOCK_HPP___
...
namespace date_time {
  ...
  public:
    ...
    static time_type local_time(sofa::pbrpc::boost::shared_ptr<time_zone_type> tz_ptr)
    {
