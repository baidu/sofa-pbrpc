#ifndef SOFA_PBRPC_DATETIME_SPECIAL_VALUE_FORMATTER_HPP___
#define SOFA_PBRPC_DATETIME_SPECIAL_VALUE_FORMATTER_HPP___
...
namespace boost { namespace date_time {
  ...
  public:
    ...
    OutItrT put_special(OutItrT next, 
                        const sofa::pbrpc::boost::date_time::special_values& value) const 
    {
