#ifndef SOFA_PBRPC_DATE_TIME_C_LOCAL_TIME_ADJUSTOR_HPP__
#define SOFA_PBRPC_DATE_TIME_C_LOCAL_TIME_ADJUSTOR_HPP__
  ...
  public:
    ...
    static time_type utc_to_local(const time_type& t)
    {
      ...
      if (t < time_t_start_time) {
        sofa::pbrpc::boost::throw_exception(std::out_of_range("Cannot convert dates prior to Jan 1, 1970"));
