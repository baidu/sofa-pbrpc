#ifndef SOFA_PBRPC_POSIXTIME_FORMATTERS_HPP___
#define SOFA_PBRPC_POSIXTIME_FORMATTERS_HPP___
...
#include <sofa/pbrpc/boost/date_time/gregorian/gregorian.hpp>
#include <sofa/pbrpc/boost/date_time/compiler_config.hpp>
#include <sofa/pbrpc/boost/date_time/iso_format.hpp>
#include <sofa/pbrpc/boost/date_time/date_format_simple.hpp>
#include <sofa/pbrpc/boost/date_time/posix_time/posix_time_types.hpp>
#include <sofa/pbrpc/boost/date_time/time_formatting_streams.hpp>
#include <sofa/pbrpc/boost/date_time/time_resolution_traits.hpp> // absolute_value
#include <sofa/pbrpc/boost/date_time/time_parsing.hpp>
...
namespace posix_time {
  ...
  inline std::basic_string<charT> to_simple_string_type(time_duration td) {
    ...
    if(td.is_special()) {
      ...
      sofa::pbrpc::boost::int64_t frac_sec =
