#ifndef SOFA_PBRPC_POSIX_TIME_CONFIG_HPP___
#define SOFA_PBRPC_POSIX_TIME_CONFIG_HPP___
...
#include <sofa/pbrpc/boost/date_time/time_duration.hpp>
#include <sofa/pbrpc/boost/date_time/time_resolution_traits.hpp>
#include <sofa/pbrpc/boost/date_time/gregorian/gregorian_types.hpp>
#include <sofa/pbrpc/boost/date_time/wrapping_int.hpp>
...
#define BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<sofa::pbrpc::boost::date_time::time_resolution_traits_adapted64_impl, sofa::pbrpc::boost::date_time::nano,
...
#undef  BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    sofa::pbrpc::boost::date_time::time_resolution_traits_adapted64_impl, sofa::pbrpc::boost::date_time::micro,
...
// #undef BOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<sofa::pbrpc::boost::int64_t, sofa::pbrpc::boost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(sofa::pbrpc::boost::date_time::special_values sv) :
...
#else
    BOOST_STATIC_CONSTANT(sofa::pbrpc::boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef sofa::pbrpc::boost::int64_t time_rep_type;
...
#if (defined(BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    BOOST_STATIC_CONSTANT(sofa::pbrpc::boost::int64_t, tick_per_second = 1000000);
#endif
  };
