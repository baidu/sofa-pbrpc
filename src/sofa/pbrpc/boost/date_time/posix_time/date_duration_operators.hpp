#ifndef SOFA_PBRPC_DATE_DURATION_OPERATORS_HPP___
#define SOFA_PBRPC_DATE_DURATION_OPERATORS_HPP___
...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const sofa::pbrpc::boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const sofa::pbrpc::boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const sofa::pbrpc::boost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const sofa::pbrpc::boost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
...
#endif // SOFA_PBRPC_DATE_DURATION_OPERATORS_HPP___
