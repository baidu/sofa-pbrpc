#ifndef SOFA_PBRPC_DATE_TIME_FORMAT_DATE_PARSER_HPP__
#define SOFA_PBRPC_DATE_TIME_FORMAT_DATE_PARSER_HPP__
...
#include "sofa/pbrpc/boost/date_time/strings_from_facet.hpp"
                    ...
                    const charT& fill_char)
{
  ...
  try {
    i = sofa::pbrpc::boost::lexical_cast<int_type>(mr.cache);
                  ...
                  unsigned int max_length)
{
  ...
  int_type i = static_cast<int_type>(-1);
  if(!s.empty()) {
    i = sofa::pbrpc::boost::lexical_cast<int_type>(s);
  }
  return i;
}
