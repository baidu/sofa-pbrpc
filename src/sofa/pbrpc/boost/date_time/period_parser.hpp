#ifndef SOFA_PBRPC_DATETIME_PERIOD_PARSER_HPP___
#define SOFA_PBRPC_DATETIME_PERIOD_PARSER_HPP___
...
namespace boost { namespace date_time {
  ...
  private:
                       ...
                       const string_type& delim) const
    {
      ...
      if(s != delim) {
        sofa::pbrpc::boost::throw_exception(std::ios_base::failure("Parse failed. Expected '"
...
#endif // SOFA_PBRPC_DATETIME_PERIOD_PARSER_HPP___
