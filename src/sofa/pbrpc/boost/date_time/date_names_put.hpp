#ifndef SOFA_PBRPC_DATE_TIME_DATE_NAMES_PUT_HPP___
#define SOFA_PBRPC_DATE_TIME_DATE_NAMES_PUT_HPP___
...
#include "sofa/pbrpc/boost/date_time/locale_config.hpp" // set BOOST_DATE_TIME_NO_LOCALE
...
namespace date_time {
    ...
    protected:
      ...
      {
        string_type s1(sofa::pbrpc::boost::lexical_cast<string_type>(s));
...
} } } } //namespace sofa::pbrpc::boost::date_time
