#ifndef SOFA_PBRPC_DATE_TIME_LOCALE_CONFIG_HPP___
#define SOFA_PBRPC_DATE_TIME_LOCALE_CONFIG_HPP___
...
#include "sofa/pbrpc/boost/config.hpp" //sets BOOST_NO_STD_LOCALE
