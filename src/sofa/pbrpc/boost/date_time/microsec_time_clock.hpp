#ifndef SOFA_PBRPC_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
#define SOFA_PBRPC_DATE_TIME_HIGHRES_TIME_CLOCK_HPP___
...
namespace date_time {
  ...
  private:
    static time_type create_time(time_converter converter)
    {
      ...
      sofa::pbrpc::boost::uint32_t sub_sec = tv.tv_usec;
      ...
      sofa::pbrpc::boost::uint32_t sub_sec = static_cast<sofa::pbrpc::boost::uint32_t>(micros % 1000000UL);
#else
