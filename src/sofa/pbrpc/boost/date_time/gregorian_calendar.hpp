#ifndef SOFA_PBRPC_DATE_TIME_GREGORIAN_CALENDAR_HPP__
#define SOFA_PBRPC_DATE_TIME_GREGORIAN_CALENDAR_HPP__
...
#include "sofa/pbrpc/boost/date_time/gregorian_calendar.ipp"
#endif
