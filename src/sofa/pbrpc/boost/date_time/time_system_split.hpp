#ifndef SOFA_PBRPC_DATE_TIME_TIME_SYSTEM_SPLIT_HPP
#define SOFA_PBRPC_DATE_TIME_TIME_SYSTEM_SPLIT_HPP
...
namespace date_time {
  ...
  template<typename config, sofa::pbrpc::boost::int32_t ticks_per_second>
#else
