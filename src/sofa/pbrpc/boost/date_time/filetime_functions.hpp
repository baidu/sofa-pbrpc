#ifndef SOFA_PBRPC_DATE_TIME_FILETIME_FUNCTIONS_HPP__
#define SOFA_PBRPC_DATE_TIME_FILETIME_FUNCTIONS_HPP__
...
#include <sofa/pbrpc/boost/date_time/time.hpp>
#include <sofa/pbrpc/boost/date_time/date_defs.hpp>
...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            sofa::pbrpc::boost::uint32_t dwLowDateTime;
            sofa::pbrpc::boost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            sofa::pbrpc::boost::uint16_t wYear;
            sofa::pbrpc::boost::uint16_t wMonth;
            sofa::pbrpc::boost::uint16_t wDayOfWeek;
            sofa::pbrpc::boost::uint16_t wDay;
            sofa::pbrpc::boost::uint16_t wHour;
            sofa::pbrpc::boost::uint16_t wMinute;
            sofa::pbrpc::boost::uint16_t wSecond;
            sofa::pbrpc::boost::uint16_t wMilliseconds;
        };
    ...
    inline sofa::pbrpc::boost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
...
}}}} // sofa::pbrpc::boost::date_time

#endif // BOOST_HAS_FTIME

#endif // SOFA_PBRPC_DATE_TIME_FILETIME_FUNCTIONS_HPP__
