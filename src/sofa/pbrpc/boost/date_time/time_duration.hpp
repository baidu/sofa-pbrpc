#ifndef SOFA_PBRPC_DATE_TIME_TIME_DURATION_HPP___
#define SOFA_PBRPC_DATE_TIME_TIME_DURATION_HPP___
...
#include <sofa/pbrpc/boost/operators.hpp>
...
namespace date_time {
  ...
  */
  ...
  class time_duration : private
      sofa::pbrpc::boost::less_than_comparable<T
    , sofa::pbrpc::boost::equality_comparable<T
    > >
   ...
   */
  template<class base_duration, sofa::pbrpc::boost::int64_t frac_of_second>
  ...
  private:
    ...
    BOOST_STATIC_CONSTANT(sofa::pbrpc::boost::int64_t, adjustment_ratio = (traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second / frac_of_second : frac_of_second / traits_type::ticks_per_second));

  public:
    explicit subsecond_duration(sofa::pbrpc::boost::int64_t ss) :
