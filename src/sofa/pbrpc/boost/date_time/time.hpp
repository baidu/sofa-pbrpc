#ifndef SOFA_PBRPC_DATE_TIME_TIME_HPP___
#define SOFA_PBRPC_DATE_TIME_TIME_HPP___
...
namespace date_time {
  ...
  */
  ...
  public:
    ...
    //!Equality operator -- others generated by sofa::pbrpc::boost::equality_comparable
    bool operator==(const time_type& rhs) const
    {
      return time_system::is_equal(time_,rhs.time_);
    }
    //!Equality operator -- others generated by sofa::pbrpc::boost::less_than_comparable
    bool operator<(const time_type& rhs) const
    {
