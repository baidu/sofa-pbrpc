#ifndef SOFA_PBRPC_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
#define SOFA_PBRPC_DATE_TIME_TIME_FORMATTING_STREAMS_HPP___
...
#include <iomanip>
#include <iostream>
#include <sofa/pbrpc/boost/date_time/date_formatting_locales.hpp>
