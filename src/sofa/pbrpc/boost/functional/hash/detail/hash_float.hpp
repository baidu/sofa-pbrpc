...
#if !defined(SOFA_PBRPC_BOOST_FUNCTIONAL_HASH_DETAIL_HASH_FLOAT_HEADER)
#define SOFA_PBRPC_BOOST_FUNCTIONAL_HASH_DETAIL_HASH_FLOAT_HEADER
...
#include <sofa/pbrpc/boost/functional/hash/detail/float_functions.hpp>
#include <sofa/pbrpc/boost/functional/hash/detail/limits.hpp>
#include <sofa/pbrpc/boost/utility/enable_if.hpp>
#include <sofa/pbrpc/boost/integer/static_log2.hpp>
...
namespace boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME sofa::pbrpc::boost::enable_if_c<
        ...
        {
            sofa::pbrpc::boost::hash_detail::call_frexp<T> frexp;
            sofa::pbrpc::boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        sofa::pbrpc::boost::static_log2<limits<T>::radix>::value
...
namespace boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return sofa::pbrpc::boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
}
