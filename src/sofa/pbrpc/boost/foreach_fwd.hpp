...
#ifndef SOFA_PBRPC_BOOST_FOREACH_FWD_HPP
#define SOFA_PBRPC_BOOST_FOREACH_FWD_HPP
...
namespace foreach
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // sofa::pbrpc::boost::foreach::is_lightweight_proxy
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // sofa::pbrpc::boost::foreach::is_noncopyable
