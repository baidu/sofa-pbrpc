...
#ifndef SOFA_PBRPC_BOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/deadline_timer_service.hpp>
...
public:
  ...
  explicit waitable_timer_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration& expiry_time, sofa::pbrpc::boost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(WaitHandler) handler)
  {
    detail::async_result_init<
      WaitHandler, void (sofa::pbrpc::boost::system::error_code)> init(
...
#endif // SOFA_PBRPC_BOOST_ASIO_WAITABLE_TIMER_SERVICE_HPP
