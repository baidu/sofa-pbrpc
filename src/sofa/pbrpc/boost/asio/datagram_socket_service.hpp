...
#ifndef SOFA_PBRPC_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
...
# include <sofa/pbrpc/boost/asio/detail/null_socket_service.hpp>
#elif defined(BOOST_ASIO_HAS_IOCP)
# include <sofa/pbrpc/boost/asio/detail/win_iocp_socket_service.hpp>
#else
# include <sofa/pbrpc/boost/asio/detail/reactive_socket_service.hpp>
#endif
...
#else
  : public sofa::pbrpc::boost::asio::detail::service_base<datagram_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit datagram_socket_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  sofa::pbrpc::boost::system::error_code open(implementation_type& impl,
      const protocol_type& protocol, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code bind(implementation_type& impl,
  ...
  sofa::pbrpc::boost::system::error_code connect(implementation_type& impl,
      const endpoint_type& peer_endpoint, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code set_option(implementation_type& impl,
      const SettableSocketOption& option, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code get_option(const implementation_type& impl,
      GettableSocketOption& option, sofa::pbrpc::boost::system::error_code& ec) const
  {
  ...
  sofa::pbrpc::boost::system::error_code io_control(implementation_type& impl,
      IoControlCommand& command, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code non_blocking(implementation_type& impl,
  ...
  sofa::pbrpc::boost::system::error_code native_non_blocking(implementation_type& impl,
      bool mode, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code shutdown(implementation_type& impl,
...
#endif // SOFA_PBRPC_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
