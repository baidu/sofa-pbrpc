...
#ifndef SOFA_PBRPC_BOOST_ASIO_BUFFERS_ITERATOR_HPP
#define SOFA_PBRPC_BOOST_ASIO_BUFFERS_ITERATOR_HPP
...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    while (new_iter.current_ != new_iter.end_)
    {
      ...
      if (sofa::pbrpc::boost::asio::buffer_size(new_iter.current_buffer_) > 0)
        break;
      ++new_iter.current_;
    }
    return new_iter;
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    while (new_iter.current_ != new_iter.end_)
    {
      ...
      new_iter.position_ += sofa::pbrpc::boost::asio::buffer_size(buffer);
      ++new_iter.current_;
    }
    return new_iter;
  }
...
private:
  ...
  void increment()
  {
    ...
    if (current_buffer_position_ != sofa::pbrpc::boost::asio::buffer_size(current_buffer_))
      return;
    ...
    while (current_ != end_)
    {
      ...
      if (sofa::pbrpc::boost::asio::buffer_size(current_buffer_) > 0)
        return;
      ++current_;
    }
  }
  ...
  void decrement()
  {
    ...
    while (iter != begin_)
    {
      ...
      std::size_t buffer_size = sofa::pbrpc::boost::asio::buffer_size(buffer);
      if (buffer_size > 0)
      {
        current_ = iter;
    ...
    if (n > 0)
    {
      ...
      for (;;)
      {
        std::ptrdiff_t current_buffer_balance
          = sofa::pbrpc::boost::asio::buffer_size(current_buffer_)
          - current_buffer_position_;
...
#endif // SOFA_PBRPC_BOOST_ASIO_BUFFERS_ITERATOR_HPP
