...
#ifndef SOFA_PBRPC_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
...
#else
  : public sofa::pbrpc::boost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  /// connections.
  sofa::pbrpc::boost::system::error_code listen(implementation_type& impl, int backlog,
      sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code accept(implementation_type& impl,
      ...
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
  {
    detail::async_result_init<
      AcceptHandler, void (sofa::pbrpc::boost::system::error_code)> init(
...
#endif // SOFA_PBRPC_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
