...
#ifndef SOFA_PBRPC_BOOST_ASIO_IO_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_IO_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/wrapped_handler.hpp>
...
# include <sofa/pbrpc/boost/asio/detail/winsock_init.hpp>
  ...
  || defined(__osf__)
# include <sofa/pbrpc/boost/asio/detail/signal_init.hpp>
#endif
 ...
 *
 * @li sofa::pbrpc::boost::asio::ip::tcp::socket
 * @li sofa::pbrpc::boost::asio::ip::tcp::acceptor
 * @li sofa::pbrpc::boost::asio::ip::udp::socket
 * @li sofa::pbrpc::boost::asio::deadline_timer.
 *
 ...
 *
 * @code
 * sofa::pbrpc::boost::asio::io_service io_service;
 * ...
 * for (;;)
 * {
 *   try
 ...
 * creating an object of type sofa::pbrpc::boost::asio::io_service::work:
 *
 * @code sofa::pbrpc::boost::asio::io_service io_service;
 * sofa::pbrpc::boost::asio::io_service::work work(io_service);
 * ... @endcode
 *
 ...
 *
 * @code sofa::pbrpc::boost::asio::io_service io_service;
 * auto_ptr<sofa::pbrpc::boost::asio::io_service::work> work(
 *     new sofa::pbrpc::boost::asio::io_service::work(io_service));
 * ...
...
public:
   ...
   * without blocking.
   */
  BOOST_ASIO_DECL std::size_t run(sofa::pbrpc::boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t run_one(sofa::pbrpc::boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t poll(sofa::pbrpc::boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL std::size_t poll_one(sofa::pbrpc::boost::system::error_code& ec);
   ...
   * @code io_service.dispatch(sofa::pbrpc::boost::bind(f, a1, ... an)); @endcode
   */
   ...
   *
   * @throws sofa::pbrpc::boost::system::system_error Thrown on failure. If the notification
   ...
   * function:
   * @code my_io_service.notify_fork(sofa::pbrpc::boost::asio::io_service::fork_prepare);
   * if (fork() == 0)
   * {
   *   // This is the child process.
   *   my_io_service.notify_fork(sofa::pbrpc::boost::asio::io_service::fork_child);
   * }
   * else
   * {
   *   // This is the parent process.
   *   my_io_service.notify_fork(sofa::pbrpc::boost::asio::io_service::fork_parent);
   * } @endcode
   *
   ...
   */
  BOOST_ASIO_DECL void notify_fork(sofa::pbrpc::boost::asio::io_service::fork_event event);
   ...
   *
   * @throws sofa::pbrpc::boost::asio::service_already_exists Thrown if a service of the
   * given type is already present in the io_service.
   *
   * @throws sofa::pbrpc::boost::asio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  sofa::pbrpc::boost::asio::detail::service_registry* service_registry_;
...
public:
   ...
   */
  explicit work(sofa::pbrpc::boost::asio::io_service& io_service);
  ...
  sofa::pbrpc::boost::asio::io_service& get_io_service();
...
protected:
   ...
   */
  BOOST_ASIO_DECL service(sofa::pbrpc::boost::asio::io_service& owner);
...
private:
  ...
  BOOST_ASIO_DECL virtual void fork_service(
      sofa::pbrpc::boost::asio::io_service::fork_event event);

  friend class sofa::pbrpc::boost::asio::detail::service_registry;
  struct key
  {
    key() : type_info_(0), id_(0) {}
    const std::type_info* type_info_;
    const sofa::pbrpc::boost::asio::io_service::id* id_;
  } key_;
...
class service_id
  : public sofa::pbrpc::boost::asio::io_service::id
{
};
...
{
public:
  static sofa::pbrpc::boost::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(sofa::pbrpc::boost::asio::io_service& io_service)
    : sofa::pbrpc::boost::asio::io_service::service(io_service)
  {
  }
};

template <typename Type>
sofa::pbrpc::boost::asio::detail::service_id<Type> service_base<Type>::id;
...
#include <sofa/pbrpc/boost/asio/impl/io_service.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/impl/io_service.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_IO_SERVICE_HPP
