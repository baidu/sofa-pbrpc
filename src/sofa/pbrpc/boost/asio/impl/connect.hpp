...
#ifndef SOFA_PBRPC_BOOST_ASIO_IMPL_CONNECT_HPP
#define SOFA_PBRPC_BOOST_ASIO_IMPL_CONNECT_HPP
...
namespace detail
{
  struct default_connect_condition
  {
    ...
    Iterator operator()(const sofa::pbrpc::boost::system::error_code&, Iterator next)
    {
      return next;
    }
  };
    ...
    sofa::pbrpc::boost::system::error_code& ec)
{
  ...
  if (!ec)
    ec = sofa::pbrpc::boost::asio::error::not_found;
...
namespace detail
{
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const sofa::pbrpc::boost::system::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const sofa::pbrpc::boost::system::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(sofa::pbrpc::boost::system::error_code ec, int start = 0)
    {
      switch (start_ = start)
      {
        case 1:
        ...
        handler_(static_cast<const sofa::pbrpc::boost::system::error_code&>(ec),
    ...
    Iterator begin, BOOST_ASIO_MOVE_ARG(ComposedConnectHandler) handler)
{
  ...
  detail::async_result_init<ComposedConnectHandler,
    void (sofa::pbrpc::boost::system::error_code, Iterator)> init(
  ...
  detail::connect_op<Protocol, SocketService, Iterator,
    detail::default_connect_condition, BOOST_ASIO_HANDLER_TYPE(
      ComposedConnectHandler, void (sofa::pbrpc::boost::system::error_code, Iterator))>(s,
        begin, Iterator(), detail::default_connect_condition(), init.handler)(
          sofa::pbrpc::boost::system::error_code(), 1);
...
#endif // SOFA_PBRPC_BOOST_ASIO_IMPL_CONNECT_HPP
