...
#ifndef SOFA_PBRPC_BOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
#define SOFA_PBRPC_BOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
...
sofa::pbrpc::boost::system::error_code serial_port_base::baud_rate::store(
    BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec) const
{
...
sofa::pbrpc::boost::system::error_code serial_port_base::baud_rate::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::flow_control::store(
    BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::flow_control::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::parity::store(
    BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
sofa::pbrpc::boost::system::error_code serial_port_base::parity::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::stop_bits::store(
    BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
sofa::pbrpc::boost::system::error_code serial_port_base::stop_bits::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::character_size::store(
    BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
sofa::pbrpc::boost::system::error_code serial_port_base::character_size::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // SOFA_PBRPC_BOOST_ASIO_IMPL_SERIAL_PORT_BASE_IPP
