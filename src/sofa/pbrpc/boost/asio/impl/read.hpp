...
#ifndef SOFA_PBRPC_BOOST_ASIO_IMPL_READ_HPP
#define SOFA_PBRPC_BOOST_ASIO_IMPL_READ_HPP
...
inline std::size_t read(SyncReadStream& s, const MutableBufferSequence& buffers)
{
  ...
  sofa::pbrpc::boost::asio::detail::throw_error(ec, "read");
...
namespace detail
{
  ...
  template <typename AsyncReadStream,
      typename CompletionCondition, typename ReadHandler>
  class read_op<AsyncReadStream, sofa::pbrpc::boost::asio::mutable_buffers_1,
  ...
  template <typename AsyncReadStream, typename Elem,
      typename CompletionCondition, typename ReadHandler>
  class read_op<AsyncReadStream, sofa::pbrpc::boost::array<Elem, 2>,
      CompletionCondition, ReadHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    read_op(AsyncReadStream& stream, const sofa::pbrpc::boost::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, ReadHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        stream_(stream),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename sofa::pbrpc::boost::asio::detail::dependent_type<Elem,
          sofa::pbrpc::boost::array<sofa::pbrpc::boost::asio::mutable_buffer, 2> >::type bufs = {{
        sofa::pbrpc::boost::asio::mutable_buffer(buffers_[0]),
        sofa::pbrpc::boost::asio::mutable_buffer(buffers_[1]) }};
  ...
  public:
    ...
    {
      typename sofa::pbrpc::boost::asio::detail::dependent_type<Elem,
          std::array<sofa::pbrpc::boost::asio::mutable_buffer, 2> >::type bufs = {{
        sofa::pbrpc::boost::asio::mutable_buffer(buffers_[0]),
        sofa::pbrpc::boost::asio::mutable_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = sofa::pbrpc::boost::asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = sofa::pbrpc::boost::asio::buffer_size(bufs[1]);
    ...
    BOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_op<AsyncReadStream, MutableBufferSequence,
    CompletionCondition, BOOST_ASIO_HANDLER_TYPE(
      ReadHandler, void (sofa::pbrpc::boost::system::error_code, std::size_t))>(
...
#endif // SOFA_PBRPC_BOOST_ASIO_IMPL_READ_HPP
