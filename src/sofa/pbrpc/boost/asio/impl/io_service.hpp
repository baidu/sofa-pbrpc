...
#ifndef SOFA_PBRPC_BOOST_ASIO_IMPL_IO_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_IMPL_IO_SERVICE_HPP
...
inline io_service::work::work(sofa::pbrpc::boost::asio::io_service& io_service)
...
inline sofa::pbrpc::boost::asio::io_service& io_service::work::get_io_service()
{
  return io_service_impl_.get_io_service();
}

inline sofa::pbrpc::boost::asio::io_service& io_service::service::get_io_service()
{
  return owner_;
}
...
#endif // SOFA_PBRPC_BOOST_ASIO_IMPL_IO_SERVICE_HPP
