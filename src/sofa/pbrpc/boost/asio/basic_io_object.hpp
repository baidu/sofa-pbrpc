...
#ifndef SOFA_PBRPC_BOOST_ASIO_BASIC_IO_OBJECT_HPP
#define SOFA_PBRPC_BOOST_ASIO_BASIC_IO_OBJECT_HPP
...
protected:
   ...
   */
  explicit basic_io_object(sofa::pbrpc::boost::asio::io_service& io_service)
    : service(sofa::pbrpc::boost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(sofa::pbrpc::boost::asio::io_service& io_service)
    : service_(&sofa::pbrpc::boost::asio::use_service<IoObjectService>(io_service))
  {
...
#endif // SOFA_PBRPC_BOOST_ASIO_BASIC_IO_OBJECT_HPP
