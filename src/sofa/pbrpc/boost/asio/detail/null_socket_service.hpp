...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  // Constructor.
  null_socket_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  sofa::pbrpc::boost::system::error_code open(implementation_type&,
      const protocol_type&, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  sofa::pbrpc::boost::system::error_code close(implementation_type&,
  ...
  sofa::pbrpc::boost::system::error_code cancel(implementation_type&,
      sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  ...
  sofa::pbrpc::boost::system::error_code listen(implementation_type&,
      int, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code io_control(implementation_type&,
      IO_Control_Command&, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code non_blocking(implementation_type&,
      bool, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code native_non_blocking(implementation_type&,
      bool, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  ...
  sofa::pbrpc::boost::system::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code bind(implementation_type&,
      const endpoint_type&, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code set_option(implementation_type&,
      const Option&, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  sofa::pbrpc::boost::system::error_code get_option(const implementation_type&,
      Option&, sofa::pbrpc::boost::system::error_code& ec) const
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(implementation_type&, const ConstBufferSequence&,
      socket_base::message_flags, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return 0;
  }
  ...
  {
    sofa::pbrpc::boost::system::error_code ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
  ...
  sofa::pbrpc::boost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  sofa::pbrpc::boost::system::error_code connect(implementation_type&,
      const endpoint_type&, sofa::pbrpc::boost::system::error_code& ec)
  {
    ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
    return ec;
...
private:
  sofa::pbrpc::boost::asio::io_service& io_service_;
};
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_SOCKET_SERVICE_HPP
