...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
#include <cstdarg>
#include <cstdio>
#include <sofa/pbrpc/boost/asio/detail/handler_tracking.hpp>
...
# endif
# include <sofa/pbrpc/boost/asio/detail/chrono_time_traits.hpp>
...
struct handler_tracking_timestamp
{
  ...
  {
#if defined(BOOST_ASIO_HAS_BOOST_DATE_TIME)
    sofa::pbrpc::boost::posix_time::ptime epoch(sofa::pbrpc::boost::gregorian::date(1970, 1, 1));
    sofa::pbrpc::boost::posix_time::time_duration now =
      sofa::pbrpc::boost::posix_time::microsec_clock::universal_time() - epoch;
#elif defined(BOOST_ASIO_HAS_STD_CHRONO)
    typedef chrono_time_traits<std::chrono::system_clock,
        sofa::pbrpc::boost::asio::wait_traits<std::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        std::chrono::system_clock::now().time_since_epoch());
#elif defined(BOOST_ASIO_HAS_BOOST_CHRONO)
    typedef chrono_time_traits<sofa::pbrpc::boost::chrono::system_clock,
        sofa::pbrpc::boost::asio::wait_traits<sofa::pbrpc::boost::chrono::system_clock> > traits_helper;
    traits_helper::posix_time_duration now(
        sofa::pbrpc::boost::chrono::system_clock::now().time_since_epoch());
#endif
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
