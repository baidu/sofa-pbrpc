...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
...
#include <sofa/pbrpc/boost/asio/detail/task_io_service_thread_info.hpp>
...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      sofa::pbrpc::boost::asio::detail::increment(
...
task_io_service::task_io_service(
    sofa::pbrpc::boost::asio::io_service& io_service, std::size_t concurrency_hint)
  : sofa::pbrpc::boost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(sofa::pbrpc::boost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(sofa::pbrpc::boost::system::error_code& ec)
{
  ec = sofa::pbrpc::boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(sofa::pbrpc::boost::system::error_code& ec)
{
  ec = sofa::pbrpc::boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(sofa::pbrpc::boost::system::error_code& ec)
{
  ec = sofa::pbrpc::boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_TASK_IO_SERVICE_IPP
