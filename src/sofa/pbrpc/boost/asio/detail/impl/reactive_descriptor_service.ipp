...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
...
sofa::pbrpc::boost::system::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, sofa::pbrpc::boost::system::error_code& ec)
{
  if (is_open(impl))
  {
...
sofa::pbrpc::boost::system::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
...
sofa::pbrpc::boost::system::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    sofa::pbrpc::boost::system::error_code& ec)
{
  if (!is_open(impl))
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
