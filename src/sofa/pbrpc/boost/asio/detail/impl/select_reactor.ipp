...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
...
select_reactor::select_reactor(sofa::pbrpc::boost::asio::io_service& io_service)
  : sofa::pbrpc::boost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  sofa::pbrpc::boost::asio::detail::signal_blocker sb;
  thread_ = new sofa::pbrpc::boost::asio::detail::thread(
...
void select_reactor::fork_service(sofa::pbrpc::boost::asio::io_service::fork_event fork_ev)
{
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SELECT_REACTOR_IPP
