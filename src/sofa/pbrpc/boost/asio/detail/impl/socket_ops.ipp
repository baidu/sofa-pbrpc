...
#include <cerrno>
#include <new>
#include <sofa/pbrpc/boost/asio/detail/assert.hpp>
...
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ec = sofa::pbrpc::boost::system::error_code(WSAGetLastError(),
...
socket_type accept(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
socket_type sync_accept(socket_type s, state_type state,
    socket_addr_type* addr, std::size_t* addrlen, sofa::pbrpc::boost::system::error_code& ec)
{
  // Accept a socket.
  for (;;)
  {
    ...
    else if (ec == sofa::pbrpc::boost::asio::error::connection_aborted)
    {
...
void complete_iocp_accept(socket_type s,
    ...
    socket_type new_socket, sofa::pbrpc::boost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = sofa::pbrpc::boost::asio::error::connection_aborted;
  ...
  if (!ec)
  {
    ...
    if (addr && addrlen)
    {
      ...
      {
        ec = sofa::pbrpc::boost::asio::error::invalid_argument;
      }
      else
      {
...
bool non_blocking_accept(socket_type s,
    ...
    sofa::pbrpc::boost::system::error_code& ec, socket_type& new_socket)
{
  for (;;)
  {
...
int close(socket_type s, state_type& state,
    bool destruction, sofa::pbrpc::boost::system::error_code& ec)
{
  int result = 0;
  if (s != invalid_socket)
  {
    ...
    if (destruction && (state & user_set_linger))
    {
      ...
      opt.l_onoff = 0;
      opt.l_linger = 0;
      sofa::pbrpc::boost::system::error_code ignored_ec;
    ...
    if (result != 0
        && (ec == sofa::pbrpc::boost::asio::error::would_block
          || ec == sofa::pbrpc::boost::asio::error::try_again))
    {
...
int shutdown(socket_type s, int what, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
    ...
    std::size_t addrlen, sofa::pbrpc::boost::system::error_code& ec)
{
  ...
  else if (ec == sofa::pbrpc::boost::asio::error::try_again)
    ec = sofa::pbrpc::boost::asio::error::no_buffer_space;
    ...
    std::size_t addrlen, sofa::pbrpc::boost::system::error_code& ec)
{
  ...
  if (ec != sofa::pbrpc::boost::asio::error::in_progress
      && ec != sofa::pbrpc::boost::asio::error::would_block)
  {
  ...
  ec = sofa::pbrpc::boost::system::error_code(connect_error,
      sofa::pbrpc::boost::asio::error::get_system_category());
}

#if defined(BOOST_ASIO_HAS_IOCP)

void complete_iocp_connect(socket_type s, sofa::pbrpc::boost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  switch (ec.value())
  {
  case ERROR_CONNECTION_REFUSED:
    ec = sofa::pbrpc::boost::asio::error::connection_refused;
    break;
  case ERROR_NETWORK_UNREACHABLE:
    ec = sofa::pbrpc::boost::asio::error::network_unreachable;
    break;
  case ERROR_HOST_UNREACHABLE:
    ec = sofa::pbrpc::boost::asio::error::host_unreachable;
    break;
  case ERROR_SEM_TIMEOUT:
    ec = sofa::pbrpc::boost::asio::error::timed_out;
    break;
  default:
    break;
  }
...
bool non_blocking_connect(socket_type s, sofa::pbrpc::boost::system::error_code& ec)
{
...
int socketpair(int af, int type, int protocol,
    socket_type sv[2], sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(af);
  (void)(type);
  (void)(protocol);
  (void)(sv);
  ec = sofa::pbrpc::boost::asio::error::operation_not_supported;
  return socket_error_retval;
#else
  clear_last_error();
...
bool sockatmark(socket_type s, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
# if defined(ENOTTY)
  if (ec.value() == ENOTTY)
    ec = sofa::pbrpc::boost::asio::error::not_socket;
...
size_t available(socket_type s, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
int listen(socket_type s, int backlog, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
signed_size_type recv(socket_type s, buf* bufs, size_t count,
    int flags, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  // Receive some data.
  ...
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = sofa::pbrpc::boost::asio::error::connection_reset;
...
size_t sync_recv(socket_type s, state_type state, buf* bufs,
    size_t count, int flags, bool all_empty, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
  ...
  for (;;)
  {
    ...
    {
      ec = sofa::pbrpc::boost::asio::error::eof;
      return 0;
    }
...
void complete_iocp_recv(state_type state,
    ...
    sofa::pbrpc::boost::system::error_code& ec, size_t bytes_transferred)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
  {
    if (cancel_token.expired())
      ec = sofa::pbrpc::boost::asio::error::operation_aborted;
    else
      ec = sofa::pbrpc::boost::asio::error::connection_reset;
  }
  else if (ec.value() == ERROR_PORT_UNREACHABLE)
...
signed_size_type recvmsg(socket_type s, buf* bufs, size_t count,
    int in_flags, int& out_flags, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  out_flags = 0;
...
int setsockopt(socket_type s, state_type& state, int level, int optname,
    const void* optval, std::size_t optlen, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
  ...
  ec = sofa::pbrpc::boost::asio::error::fault;
  return socket_error_retval;
...
int getsockopt(socket_type s, state_type state, int level, int optname,
    void* optval, size_t* optlen, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
int getpeername(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, bool cached, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
  ...
  if (cached)
  {
    ...
    {
      ec = sofa::pbrpc::boost::asio::error::not_connected;
      return socket_error_retval;
    }
...
int select(int nfds, fd_set* readfds, fd_set* writefds,
    fd_set* exceptfds, timeval* timeout, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ...
  // system clock (as wrapped by sofa::pbrpc::boost::posix_time::microsec_clock) typically
...
int poll_read(socket_type s, state_type state, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
  ...
  if (result == 0)
    ec = (state & user_set_non_blocking)
      ? sofa::pbrpc::boost::asio::error::would_block : sofa::pbrpc::boost::system::error_code();
  else if (result > 0)
    ec = sofa::pbrpc::boost::system::error_code();
  return result;
}

int poll_write(socket_type s, state_type state, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
int poll_connect(socket_type s, sofa::pbrpc::boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = sofa::pbrpc::boost::asio::error::bad_descriptor;
...
const char* inet_ntop(int af, const void* src, char* dest, size_t length,
    unsigned long scope_id, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  ...
  {
    ec = sofa::pbrpc::boost::asio::error::address_family_not_supported;
    return 0;
  }
#elif defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  using namespace std; // For memcpy.
...
int gethostname(char* name, int namelen, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  try
  ...
  {
    ec = sofa::pbrpc::boost::system::error_code(e->HResult,
        sofa::pbrpc::boost::system::system_category());
    return -1;
  }
...
inline sofa::pbrpc::boost::system::error_code translate_netdb_error(int error)
{
  switch (error)
  {
  case 0:
    return sofa::pbrpc::boost::system::error_code();
  case HOST_NOT_FOUND:
    return sofa::pbrpc::boost::asio::error::host_not_found;
  case TRY_AGAIN:
    return sofa::pbrpc::boost::asio::error::host_not_found_try_again;
  case NO_RECOVERY:
    return sofa::pbrpc::boost::asio::error::no_recovery;
  case NO_DATA:
    return sofa::pbrpc::boost::asio::error::no_data;
  default:
    BOOST_ASIO_ASSERT(false);
    return sofa::pbrpc::boost::asio::error::invalid_argument;
  }
}

inline hostent* gethostbyaddr(const char* addr, int length, int af,
    hostent* result, char* buffer, int buflength, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
...
inline hostent* gethostbyname(const char* name, int af, struct hostent* result,
    char* buffer, int buflength, int ai_flags, sofa::pbrpc::boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
    ...
    const addrinfo_type* hintsp, addrinfo_type** result)
{
  ...
  for (gai_search* sptr = search; sptr < search + search_count; ++sptr)
  {
    ...
    if (hptr == 0)
    {
      ...
      freeaddrinfo_emulation(aihead);
      gai_free(canon);
      if (ec == sofa::pbrpc::boost::asio::error::host_not_found)
        return EAI_NONAME;
      if (ec == sofa::pbrpc::boost::asio::error::host_not_found_try_again)
        return EAI_AGAIN;
      if (ec == sofa::pbrpc::boost::asio::error::no_recovery)
        return EAI_FAIL;
      if (ec == sofa::pbrpc::boost::asio::error::no_data)
        return EAI_NONAME;
      return EAI_NONAME;
    }
...
inline sofa::pbrpc::boost::system::error_code getnameinfo_emulation(
    ...
    sofa::pbrpc::boost::system::error_code& ec)
{
  ...
  case BOOST_ASIO_OS_DEF(AF_INET):
    ...
    {
      return ec = sofa::pbrpc::boost::asio::error::invalid_argument;
    }
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    return ec = sofa::pbrpc::boost::asio::error::address_family_not_supported;
  }
  ...
  if (host && hostlen > 0)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          return ec = sofa::pbrpc::boost::asio::error::host_not_found;
        }
  ...
  if (serv && servlen > 0)
  {
    if (flags & NI_NUMERICSERV)
    {
      if (servlen < 6)
      {
        return ec = sofa::pbrpc::boost::asio::error::no_buffer_space;
      }
#if defined(BOOST_ASIO_HAS_SECURE_RTL)
...
inline sofa::pbrpc::boost::system::error_code translate_addrinfo_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case EAI_FAIL:
    return sofa::pbrpc::boost::asio::error::no_recovery;
  case EAI_FAMILY:
    return sofa::pbrpc::boost::asio::error::address_family_not_supported;
  case EAI_MEMORY:
    return sofa::pbrpc::boost::asio::error::no_memory;
  case EAI_NONAME:
  ...
  case EAI_NODATA:
    ...
    return sofa::pbrpc::boost::asio::error::host_not_found;
  case EAI_SERVICE:
    return sofa::pbrpc::boost::asio::error::service_not_found;
  case EAI_SOCKTYPE:
    return sofa::pbrpc::boost::asio::error::socket_type_not_supported;
  default: // Possibly the non-portable EAI_SYSTEM.
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    return sofa::pbrpc::boost::system::error_code(
        WSAGetLastError(), sofa::pbrpc::boost::asio::error::get_system_category());
#else
    return sofa::pbrpc::boost::system::error_code(
        errno, sofa::pbrpc::boost::asio::error::get_system_category());
#endif
  }
}

sofa::pbrpc::boost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, sofa::pbrpc::boost::system::error_code& ec)
{
...
sofa::pbrpc::boost::system::error_code background_getaddrinfo(
...
sofa::pbrpc::boost::system::error_code getnameinfo(const socket_addr_type* addr,
    std::size_t addrlen, char* host, std::size_t hostlen,
    char* serv, std::size_t servlen, int flags, sofa::pbrpc::boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# if defined(BOOST_ASIO_HAS_GETADDRINFO)
  // Building for Windows XP, Windows Server 2003, or later.
...
sofa::pbrpc::boost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, sofa::pbrpc::boost::system::error_code& ec)
{
...
sofa::pbrpc::boost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, sofa::pbrpc::boost::system::error_code& ec)
