...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
...
#include <vector>
#include <sofa/pbrpc/boost/asio/detail/service_registry.hpp>
...
service_registry::~service_registry()
{
  ...
  sofa::pbrpc::boost::asio::io_service::service* service = first_service_;
  while (service)
  {
  ...
  {
    sofa::pbrpc::boost::asio::io_service::service* next_service = first_service_->next_;
    destroy(first_service_);
    first_service_ = next_service;
  }
}

void service_registry::notify_fork(sofa::pbrpc::boost::asio::io_service::fork_event fork_ev)
{
  // Make a copy of all of the services while holding the lock. We don't want
  // to hold the lock while calling into each service, as it may try to call
  // back into this class.
  std::vector<sofa::pbrpc::boost::asio::io_service::service*> services;
  {
    sofa::pbrpc::boost::asio::detail::mutex::scoped_lock lock(mutex_);
    sofa::pbrpc::boost::asio::io_service::service* service = first_service_;
    while (service)
    {
  ...
  if (fork_ev == sofa::pbrpc::boost::asio::io_service::fork_prepare)
...
void service_registry::destroy(sofa::pbrpc::boost::asio::io_service::service* service)
{
  delete service;
}

sofa::pbrpc::boost::asio::io_service::service* service_registry::do_use_service(
    ...
    sofa::pbrpc::boost::asio::io_service::service* new_service)
{
  if (&owner_ != &new_service->get_io_service())
    sofa::pbrpc::boost::asio::detail::throw_exception(invalid_service_owner());
  ...
  {
    if (keys_match(service->key_, key))
      sofa::pbrpc::boost::asio::detail::throw_exception(service_already_exists());
    service = service->next_;
  }
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
