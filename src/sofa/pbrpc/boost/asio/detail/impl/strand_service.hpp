...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/completion_handler.hpp>
    ...
    Handler& handler)
{
  ...
  if (dispatch_immediately)
  {
    ...
    completion_handler<Handler>::do_complete(
        &io_service_, o, sofa::pbrpc::boost::system::error_code(), 0);
  }
}
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_STRAND_SERVICE_HPP
