...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
...
dev_poll_reactor::dev_poll_reactor(sofa::pbrpc::boost::asio::io_service& io_service)
  : sofa::pbrpc::boost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(sofa::pbrpc::boost::asio::io_service::fork_event fork_ev)
{
...
{
  sofa::pbrpc::boost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, sofa::pbrpc::boost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(bool block, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      sofa::pbrpc::boost::system::error_code ec = sofa::pbrpc::boost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    sofa::pbrpc::boost::system::error_code ec(errno,
        sofa::pbrpc::boost::asio::error::get_system_category());
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_DEV_POLL_REACTOR_IPP
