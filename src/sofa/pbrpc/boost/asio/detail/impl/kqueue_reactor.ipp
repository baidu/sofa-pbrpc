...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_KQUEUE_REACTOR_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_KQUEUE_REACTOR_IPP
...
kqueue_reactor::kqueue_reactor(sofa::pbrpc::boost::asio::io_service& io_service)
  : sofa::pbrpc::boost::asio::detail::service_base<kqueue_reactor>(io_service),
    ...
    shutdown_(false)
{
  ...
  {
    sofa::pbrpc::boost::system::error_code error(errno,
        sofa::pbrpc::boost::asio::error::get_system_category());
    sofa::pbrpc::boost::asio::detail::throw_error(error);
  }
}
...
void kqueue_reactor::fork_service(sofa::pbrpc::boost::asio::io_service::fork_event fork_ev)
{
  if (fork_ev == sofa::pbrpc::boost::asio::io_service::fork_child)
  {
    ...
    if (::kevent(kqueue_fd_, events, 1, 0, 0, 0) == -1)
    {
      sofa::pbrpc::boost::system::error_code ec(errno,
          sofa::pbrpc::boost::asio::error::get_system_category());
      sofa::pbrpc::boost::asio::detail::throw_error(ec, "kqueue interrupter registration");
    }
        ...
        state != 0; state = state->next_)
    {
      if (state->num_kevents_ > 0)
      {
        ...
        if (::kevent(kqueue_fd_, events, state->num_kevents_, 0, 0, 0) == -1)
        {
          sofa::pbrpc::boost::system::error_code ec(errno,
              sofa::pbrpc::boost::asio::error::get_system_category());
          sofa::pbrpc::boost::asio::detail::throw_error(ec, "kqueue re-registration");
        }
      }
    }
  }
    ...
    bool is_continuation, bool allow_speculative)
{
  if (!descriptor_data)
  {
    op->ec_ = sofa::pbrpc::boost::asio::error::bad_descriptor;
  ...
  if (descriptor_data->op_queue_[op_type].empty())
  {
          ...
          || descriptor_data->op_queue_[except_op].empty()))
    {
      ...
      if (descriptor_data->num_kevents_ < num_kevents[op_type])
      {
        ...
        {
          op->ec_ = sofa::pbrpc::boost::system::error_code(errno,
              sofa::pbrpc::boost::asio::error::get_system_category());
          io_service_.post_immediate_completion(op, is_continuation);
          return;
        }
...
int kqueue_reactor::do_kqueue_create()
{
  ...
  if (fd == -1)
  {
    sofa::pbrpc::boost::system::error_code ec(errno,
        sofa::pbrpc::boost::asio::error::get_system_category());
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "kqueue");
  }
  return fd;
}
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_KQUEUE_REACTOR_IPP
