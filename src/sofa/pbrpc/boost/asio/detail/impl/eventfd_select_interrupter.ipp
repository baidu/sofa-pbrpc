...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
...
# endif // defined(EFD_CLOEXEC) && defined(EFD_NONBLOCK)
  ...
  if (read_descriptor_ == -1)
  {
    ...
    else
    {
      ...
      sofa::pbrpc::boost::asio::detail::throw_error(ec, "eventfd_select_interrupter");
    }
  }
}
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
