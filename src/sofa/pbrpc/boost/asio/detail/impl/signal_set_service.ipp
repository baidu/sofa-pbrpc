...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
...
#include <sofa/pbrpc/boost/asio/detail/signal_blocker.hpp>
#include <sofa/pbrpc/boost/asio/detail/signal_set_service.hpp>
#include <sofa/pbrpc/boost/asio/detail/static_mutex.hpp>
...
signal_set_service::signal_set_service(
  ...
  : io_service_(sofa::pbrpc::boost::asio::use_service<io_service_impl>(io_service)),
#if !defined(BOOST_ASIO_WINDOWS) \
  && !defined(BOOST_ASIO_WINDOWS_RUNTIME) \
  && !defined(__CYGWIN__)
    reactor_(sofa::pbrpc::boost::asio::use_service<reactor>(io_service)),
#endif // !defined(BOOST_ASIO_WINDOWS)
       //   && !defined(BOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
    next_(0),
...
void signal_set_service::fork_service(
    sofa::pbrpc::boost::asio::io_service::fork_event fork_ev)
{
#if !defined(BOOST_ASIO_WINDOWS) \
  && !defined(BOOST_ASIO_WINDOWS_RUNTIME) \
  && !defined(__CYGWIN__)
  ...
  switch (fork_ev)
  {
  case sofa::pbrpc::boost::asio::io_service::fork_prepare:
    {
    ...
    break;
  case sofa::pbrpc::boost::asio::io_service::fork_parent:
    ...
    break;
  case sofa::pbrpc::boost::asio::io_service::fork_child:
    if (state->fork_prepared_)
    {
      sofa::pbrpc::boost::asio::detail::signal_blocker blocker;
      close_descriptors();
      open_descriptors();
      int read_descriptor = state->read_descriptor_;
      state->fork_prepared_ = false;
...
sofa::pbrpc::boost::system::error_code signal_set_service::add(
    signal_set_service::implementation_type& impl,
    int signal_number, sofa::pbrpc::boost::system::error_code& ec)
{
...
sofa::pbrpc::boost::system::error_code signal_set_service::remove(
    signal_set_service::implementation_type& impl,
    int signal_number, sofa::pbrpc::boost::system::error_code& ec)
{
  // Check that the signal number is valid.
...
sofa::pbrpc::boost::system::error_code signal_set_service::clear(
    signal_set_service::implementation_type& impl,
...
sofa::pbrpc::boost::system::error_code signal_set_service::cancel(
    signal_set_service::implementation_type& impl,
    sofa::pbrpc::boost::system::error_code& ec)
{
  ...
  op_queue<operation> ops;
  {
    ...
    {
      op->ec_ = sofa::pbrpc::boost::asio::error::operation_aborted;
      impl.queue_.pop();
      ops.push(op);
    }
  }
...
void signal_set_service::open_descriptors()
{
  ...
  {
    sofa::pbrpc::boost::system::error_code ec(errno,
        sofa::pbrpc::boost::asio::error::get_system_category());
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "signal_set_service pipe");
  }
#endif // !defined(BOOST_ASIO_WINDOWS)
       //   && !defined(BOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_IMPL_SIGNAL_SET_SERVICE_IPP
