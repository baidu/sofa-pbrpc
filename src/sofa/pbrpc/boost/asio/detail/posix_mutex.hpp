...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_MUTEX_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_MUTEX_HPP
...
{
public:
  typedef sofa::pbrpc::boost::asio::detail::scoped_lock<posix_mutex> scoped_lock;
...
# include <sofa/pbrpc/boost/asio/detail/impl/posix_mutex.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // defined(BOOST_ASIO_HAS_PTHREADS)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_MUTEX_HPP
