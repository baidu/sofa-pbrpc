...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_BUFFERED_STREAM_STORAGE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_BUFFERED_STREAM_STORAGE_HPP
...
public:
  ...
  mutable_buffer data()
  {
    return sofa::pbrpc::boost::asio::buffer(buffer_) + begin_offset_;
  }
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_BUFFERED_STREAM_STORAGE_HPP
