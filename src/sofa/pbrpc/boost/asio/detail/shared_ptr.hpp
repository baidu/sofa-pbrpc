...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_SHARED_PTR_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_SHARED_PTR_HPP
...
#else // defined(BOOST_ASIO_HAS_STD_SHARED_PTR)
using sofa::pbrpc::boost::shared_ptr;
#endif // defined(BOOST_ASIO_HAS_STD_SHARED_PTR)
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_SHARED_PTR_HPP
