...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TYPE_REQUIREMENTS_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TYPE_REQUIREMENTS_HPP
...
#define BOOST_ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(sofa::pbrpc::boost::asio::detail::zero_arg_handler_test( \
          sofa::pbrpc::boost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef sofa::pbrpc::boost::asio::detail::handler_type_requirements< \
      sizeof( \
        sofa::pbrpc::boost::asio::detail::argbyv( \
          sofa::pbrpc::boost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        sofa::pbrpc::boost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(sofa::pbrpc::boost::asio::detail::two_arg_handler_test( \
          sofa::pbrpc::boost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const sofa::pbrpc::boost::system::error_code*>(0), \
  ...
  typedef sofa::pbrpc::boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        sofa::pbrpc::boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            sofa::pbrpc::boost::asio::detail::lvref<const sofa::pbrpc::boost::system::error_code>(), \
            sofa::pbrpc::boost::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(sofa::pbrpc::boost::asio::detail::one_arg_handler_test( \
          sofa::pbrpc::boost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const sofa::pbrpc::boost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(sofa::pbrpc::boost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(sofa::pbrpc::boost::asio::detail::two_arg_handler_test( \
  ...
  typedef sofa::pbrpc::boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        sofa::pbrpc::boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            sofa::pbrpc::boost::asio::detail::lvref<const sofa::pbrpc::boost::system::error_code>(), \
            sofa::pbrpc::boost::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
  ...
  typedef sofa::pbrpc::boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        sofa::pbrpc::boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            sofa::pbrpc::boost::asio::detail::lvref<const sofa::pbrpc::boost::system::error_code>(), \
            sofa::pbrpc::boost::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TYPE_REQUIREMENTS_HPP
