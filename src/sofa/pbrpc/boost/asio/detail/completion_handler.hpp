...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_COMPLETION_HANDLER_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_COMPLETION_HANDLER_HPP
...
public:
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    p.h = sofa::pbrpc::boost::asio::detail::addressof(handler);
    p.reset();
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_COMPLETION_HANDLER_HPP
