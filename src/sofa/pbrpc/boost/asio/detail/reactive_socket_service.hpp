...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/reactive_socket_accept_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/reactive_socket_connect_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/reactive_socket_recvfrom_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/reactive_socket_sendto_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/reactive_socket_service_base.hpp>
...
public:
  ...
  // Constructor.
  reactive_socket_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  sofa::pbrpc::boost::system::error_code set_option(implementation_type& impl,
      const Option& option, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code get_option(const implementation_type& impl,
      Option& option, sofa::pbrpc::boost::system::error_code& ec) const
  {
  ...
  sofa::pbrpc::boost::system::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, sofa::pbrpc::boost::system::error_code& ec)
  {
    // We cannot accept a socket that is already open.
    if (peer.is_open())
    {
      ec = sofa::pbrpc::boost::asio::error::already_open;
      return ec;
    }
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
