...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_GCC_ARM_FENCED_BLOCK_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_GCC_ARM_FENCED_BLOCK_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_GCC_ARM_FENCED_BLOCK_HPP
