...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_BIND_HANDLER_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_BIND_HANDLER_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_BIND_HANDLER_HPP
