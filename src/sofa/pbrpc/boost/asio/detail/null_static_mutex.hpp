...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_STATIC_MUTEX_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_STATIC_MUTEX_HPP
...
{
  typedef sofa::pbrpc::boost::asio::detail::scoped_lock<null_static_mutex> scoped_lock;
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_NULL_STATIC_MUTEX_HPP
