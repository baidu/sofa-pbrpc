...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TRACKING_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TRACKING_HPP
...
# include <sofa/pbrpc/boost/asio/detail/tss_ptr.hpp>
...
public:
  ...
  public:
    ...
    BOOST_ASIO_DECL void invocation_begin(const sofa::pbrpc::boost::system::error_code& ec);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const sofa::pbrpc::boost::system::error_code& ec, std::size_t bytes_transferred);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const sofa::pbrpc::boost::system::error_code& ec, int signal_number);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const sofa::pbrpc::boost::system::error_code& ec, const char* arg);
...
# define BOOST_ASIO_INHERIT_TRACKED_HANDLER \
  : public sofa::pbrpc::boost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public sofa::pbrpc::boost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_HANDLER_TRACKING_INIT \
  sofa::pbrpc::boost::asio::detail::handler_tracking::init()

# define BOOST_ASIO_HANDLER_CREATION(args) \
  sofa::pbrpc::boost::asio::detail::handler_tracking::creation args

# define BOOST_ASIO_HANDLER_COMPLETION(args) \
  sofa::pbrpc::boost::asio::detail::handler_tracking::completion tracked_completion args
...
# define BOOST_ASIO_HANDLER_OPERATION(args) \
  sofa::pbrpc::boost::asio::detail::handler_tracking::operation args
...
# include <sofa/pbrpc/boost/asio/detail/impl/handler_tracking.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_HANDLER_TRACKING_HPP
