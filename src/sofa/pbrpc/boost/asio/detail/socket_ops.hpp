...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_SOCKET_OPS_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_SOCKET_OPS_HPP
...
#include <sofa/pbrpc/boost/asio/detail/shared_ptr.hpp>
#include <sofa/pbrpc/boost/asio/detail/socket_types.hpp>
#include <sofa/pbrpc/boost/asio/detail/weak_ptr.hpp>
...
BOOST_ASIO_DECL int shutdown(socket_type s,
    int what, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL bool sockatmark(socket_type s, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL int listen(socket_type s,
    int backlog, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL size_t sync_send(socket_type s, state_type state,
    ...
    bool all_empty, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL int setsockopt(socket_type s, state_type& state,
    ...
    std::size_t optlen, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL int getsockopt(socket_type s, state_type state,
    int level, int optname, void* optval,
    size_t* optlen, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_connect(socket_type s, sofa::pbrpc::boost::system::error_code& ec);

#endif // !defined(BOOST_ASIO_WINDOWS_RUNTIME)

BOOST_ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, sofa::pbrpc::boost::system::error_code& ec);
...
BOOST_ASIO_DECL int gethostname(char* name,
    int namelen, sofa::pbrpc::boost::system::error_code& ec);

#if !defined(BOOST_ASIO_WINDOWS_RUNTIME)

BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, sofa::pbrpc::boost::system::error_code& ec);

BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, sofa::pbrpc::boost::system::error_code& ec);
...
# include <sofa/pbrpc/boost/asio/detail/impl/socket_ops.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_SOCKET_OPS_HPP
