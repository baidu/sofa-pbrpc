...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_PTIME_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_PTIME_HPP
...
struct forwarding_posix_time_traits : time_traits<sofa::pbrpc::boost::posix_time::ptime> {};

// Template specialisation for the commonly used instantation.
template <>
class timer_queue<time_traits<sofa::pbrpc::boost::posix_time::ptime> >
  : public timer_queue_base
{
public:
  // The time type.
  typedef sofa::pbrpc::boost::posix_time::ptime time_type;

  // The duration type.
  typedef sofa::pbrpc::boost::posix_time::time_duration duration_type;
...
# include <sofa/pbrpc/boost/asio/detail/impl/timer_queue_ptime.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_PTIME_HPP
