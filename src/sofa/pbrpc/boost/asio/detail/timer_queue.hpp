...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/date_time_fwd.hpp>
...
private:
  ...
  static bool is_positive_infinity(
      const sofa::pbrpc::boost::date_time::base_time<T, TimeSystem>& time)
  {
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_TIMER_QUEUE_HPP
