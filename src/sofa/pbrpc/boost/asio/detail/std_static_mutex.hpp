...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
...
{
public:
  typedef sofa::pbrpc::boost::asio::detail::scoped_lock<std_static_mutex> scoped_lock;
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_STD_STATIC_MUTEX_HPP
