...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_SCOPED_LOCK_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_SCOPED_LOCK_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_SCOPED_LOCK_HPP
