...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/descriptor_read_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/descriptor_write_op.hpp>
...
public:
  ...
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code close(implementation_type& impl,
      sofa::pbrpc::boost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code cancel(implementation_type& impl,
      sofa::pbrpc::boost::system::error_code& ec);
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, sofa::pbrpc::boost::system::error_code& ec)
  {
...
# include <sofa/pbrpc/boost/asio/detail/impl/reactive_descriptor_service.ipp>
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
