...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVE_OP_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVE_OP_HPP
...
public:
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    else
    {
      ...
      detail::binder2<Handler, sofa::pbrpc::boost::system::error_code, iterator_type>
...
private:
  ...
  sofa::pbrpc::boost::asio::detail::addrinfo_type* addrinfo_;
};
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVE_OP_HPP
