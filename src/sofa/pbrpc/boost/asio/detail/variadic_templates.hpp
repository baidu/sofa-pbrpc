...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_VARIADIC_TEMPLATES_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_VARIADIC_TEMPLATES_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_VARIADIC_TEMPLATES_HPP
