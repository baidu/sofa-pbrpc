...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
...
#include <cstddef>
#include <sofa/pbrpc/boost/asio/detail/fd_set_adapter.hpp>
#include <sofa/pbrpc/boost/asio/detail/limits.hpp>
...
#include <sofa/pbrpc/boost/asio/detail/select_interrupter.hpp>
#include <sofa/pbrpc/boost/asio/detail/socket_types.hpp>
#include <sofa/pbrpc/boost/asio/detail/timer_queue_base.hpp>
#include <sofa/pbrpc/boost/asio/detail/timer_queue_set.hpp>
...
class select_reactor
  : public sofa::pbrpc::boost::asio::detail::service_base<select_reactor>
{
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL select_reactor(sofa::pbrpc::boost::asio::io_service& io_service);
...
private:
  ...
  sofa::pbrpc::boost::asio::detail::thread* thread_;
#endif // defined(BOOST_ASIO_HAS_IOCP)
...
#include <sofa/pbrpc/boost/asio/detail/impl/select_reactor.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/detail/impl/select_reactor.ipp>
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_SELECT_REACTOR_HPP
