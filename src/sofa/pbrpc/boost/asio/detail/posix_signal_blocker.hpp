...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_SIGNAL_BLOCKER_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_SIGNAL_BLOCKER_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_POSIX_SIGNAL_BLOCKER_HPP
