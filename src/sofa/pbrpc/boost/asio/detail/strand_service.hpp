...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
...
class strand_service
  : public sofa::pbrpc::boost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  BOOST_ASIO_DECL explicit strand_service(sofa::pbrpc::boost::asio::io_service& io_service);
...
private:
  ...
  BOOST_ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const sofa::pbrpc::boost::system::error_code& ec,
...
#include <sofa/pbrpc/boost/asio/detail/impl/strand_service.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/detail/impl/strand_service.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_STRAND_SERVICE_HPP
