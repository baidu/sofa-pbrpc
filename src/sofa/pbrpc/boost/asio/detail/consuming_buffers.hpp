...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
...
class consuming_buffers<Buffer, sofa::pbrpc::boost::asio::null_buffers>
  : public sofa::pbrpc::boost::asio::null_buffers
{
public:
  consuming_buffers(const sofa::pbrpc::boost::asio::null_buffers&)
  {
    // No-op.
  }
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_CONSUMING_BUFFERS_HPP
