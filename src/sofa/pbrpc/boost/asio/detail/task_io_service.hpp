...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/atomic_count.hpp>
#include <sofa/pbrpc/boost/asio/detail/call_stack.hpp>
#include <sofa/pbrpc/boost/asio/detail/event.hpp>
#include <sofa/pbrpc/boost/asio/detail/mutex.hpp>
#include <sofa/pbrpc/boost/asio/detail/op_queue.hpp>
...
class task_io_service
  : public sofa::pbrpc::boost::asio::detail::service_base<task_io_service>
{
public:
  ...
  BOOST_ASIO_DECL task_io_service(sofa::pbrpc::boost::asio::io_service& io_service,
...
private:
  ...
  BOOST_ASIO_DECL std::size_t do_run_one(mutex::scoped_lock& lock,
      thread_info& this_thread, const sofa::pbrpc::boost::system::error_code& ec);
...
#include <sofa/pbrpc/boost/asio/detail/impl/task_io_service.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/detail/impl/task_io_service.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // !defined(BOOST_ASIO_HAS_IOCP)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP
