...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/resolve_endpoint_op.hpp>
#include <sofa/pbrpc/boost/asio/detail/resolve_op.hpp>
...
public:
  ...
  // The query type.
  typedef sofa::pbrpc::boost::asio::ip::basic_resolver_query<Protocol> query_type;

  // The iterator type.
  typedef sofa::pbrpc::boost::asio::ip::basic_resolver_iterator<Protocol> iterator_type;

  // Constructor.
  resolver_service(sofa::pbrpc::boost::asio::io_service& io_service)
  ...
  {
    sofa::pbrpc::boost::asio::detail::addrinfo_type* address_info = 0;
...
#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_RESOLVER_SERVICE_HPP
