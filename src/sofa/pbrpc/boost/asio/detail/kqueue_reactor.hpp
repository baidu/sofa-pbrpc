...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
...
class kqueue_reactor
  : public sofa::pbrpc::boost::asio::detail::service_base<kqueue_reactor>
{
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL kqueue_reactor(sofa::pbrpc::boost::asio::io_service& io_service);
...
#include <sofa/pbrpc/boost/asio/detail/impl/kqueue_reactor.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/detail/impl/kqueue_reactor.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // defined(BOOST_ASIO_HAS_KQUEUE)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_KQUEUE_REACTOR_HPP
