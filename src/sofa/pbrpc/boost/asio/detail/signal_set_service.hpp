...
#ifndef SOFA_PBRPC_BOOST_ASIO_DETAIL_SIGNAL_SET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_DETAIL_SIGNAL_SET_SERVICE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/signal_handler.hpp>
#include <sofa/pbrpc/boost/asio/detail/signal_op.hpp>
...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL signal_set_service(sofa::pbrpc::boost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code add(implementation_type& impl,
      int signal_number, sofa::pbrpc::boost::system::error_code& ec);

  // Remove a signal to a signal_set.
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code remove(implementation_type& impl,
      int signal_number, sofa::pbrpc::boost::system::error_code& ec);

  // Remove all signals from a signal_set.
  BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code clear(implementation_type& impl,
...
# include <sofa/pbrpc/boost/asio/detail/impl/signal_set_service.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_DETAIL_SIGNAL_SET_SERVICE_HPP
