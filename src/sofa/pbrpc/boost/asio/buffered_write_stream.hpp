...
#ifndef SOFA_PBRPC_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
#define SOFA_PBRPC_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
...
public:
  ...
  /// error occurred.
  std::size_t flush(sofa::pbrpc::boost::system::error_code& ec);
...
#include <sofa/pbrpc/boost/asio/impl/buffered_write_stream.hpp>

#endif // SOFA_PBRPC_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
