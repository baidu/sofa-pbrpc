...
#ifndef SOFA_PBRPC_BOOST_ASIO_ASYNC_RESULT_HPP
#define SOFA_PBRPC_BOOST_ASIO_ASYNC_RESULT_HPP
...
# define BOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::sofa::pbrpc::boost::asio::detail::async_result_type_helper<h, sig>::type
#else
# define BOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::sofa::pbrpc::boost::asio::async_result< \
    typename ::sofa::pbrpc::boost::asio::handler_type<h, sig>::type>::type
#endif

#endif // SOFA_PBRPC_BOOST_ASIO_ASYNC_RESULT_HPP
