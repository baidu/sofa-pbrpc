...
#ifndef SOFA_PBRPC_BOOST_ASIO_SERIAL_PORT_BASE_HPP
#define SOFA_PBRPC_BOOST_ASIO_SERIAL_PORT_BASE_HPP
...
public:
  ...
  public:
    ...
    BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code store(
        BOOST_ASIO_OPTION_STORAGE& storage,
        sofa::pbrpc::boost::system::error_code& ec) const;
    BOOST_ASIO_DECL sofa::pbrpc::boost::system::error_code load(
...
#include <sofa/pbrpc/boost/asio/impl/serial_port_base.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/impl/serial_port_base.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // defined(BOOST_ASIO_HAS_SERIAL_PORT)
       //   || defined(GENERATING_DOCUMENTATION)

#endif // SOFA_PBRPC_BOOST_ASIO_SERIAL_PORT_BASE_HPP
