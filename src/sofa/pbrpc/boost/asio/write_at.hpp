...
#ifndef SOFA_PBRPC_BOOST_ASIO_WRITE_AT_HPP
#define SOFA_PBRPC_BOOST_ASIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at sofa::pbrpc::boost::asio::write_at
 *
 ...
 * @code sofa::pbrpc::boost::asio::write_at(d, 42, sofa::pbrpc::boost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, sofa::pbrpc::boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code sofa::pbrpc::boost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code sofa::pbrpc::boost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code sofa::pbrpc::boost::asio::write_at(d, 42, sofa::pbrpc::boost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at sofa::pbrpc::boost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * sofa::pbrpc::boost::asio::async_write_at(d, 42, sofa::pbrpc::boost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, sofa::pbrpc::boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code sofa::pbrpc::boost::asio::async_write_at(d, 42,
...
#include <sofa/pbrpc/boost/asio/impl/write_at.hpp>

#endif // SOFA_PBRPC_BOOST_ASIO_WRITE_AT_HPP
