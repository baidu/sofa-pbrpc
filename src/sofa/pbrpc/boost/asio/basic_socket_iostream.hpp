...
#ifndef SOFA_PBRPC_BOOST_ASIO_BASIC_SOCKET_IOSTREAM_HPP
#define SOFA_PBRPC_BOOST_ASIO_BASIC_SOCKET_IOSTREAM_HPP
...
public:
   ...
   * } @endcode
   */
  const sofa::pbrpc::boost::system::error_code& error() const
  {
...
#endif // SOFA_PBRPC_BOOST_ASIO_BASIC_SOCKET_IOSTREAM_HPP
