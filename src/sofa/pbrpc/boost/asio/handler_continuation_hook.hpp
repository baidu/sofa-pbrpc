...
#ifndef SOFA_PBRPC_BOOST_ASIO_HANDLER_CONTINUATION_HOOK_HPP
#define SOFA_PBRPC_BOOST_ASIO_HANDLER_CONTINUATION_HOOK_HPP
...
#endif // SOFA_PBRPC_BOOST_ASIO_HANDLER_CONTINUATION_HOOK_HPP
