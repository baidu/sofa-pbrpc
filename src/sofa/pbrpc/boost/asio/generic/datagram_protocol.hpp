...
#ifndef SOFA_PBRPC_BOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
#define SOFA_PBRPC_BOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
...
/**
 * The sofa::pbrpc::boost::asio::generic::datagram_protocol class contains flags necessary
 ...
 * @code datagram_protocol p(sofa::pbrpc::boost::asio::ip::udp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // SOFA_PBRPC_BOOST_ASIO_GENERIC_DATAGRAM_PROTOCOL_HPP
