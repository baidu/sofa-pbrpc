...
#ifndef SOFA_PBRPC_BOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
#define SOFA_PBRPC_BOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The sofa::pbrpc::boost::asio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(sofa::pbrpc::boost::asio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // SOFA_PBRPC_BOOST_ASIO_GENERIC_RAW_PROTOCOL_HPP
