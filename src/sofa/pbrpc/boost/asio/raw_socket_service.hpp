...
#ifndef SOFA_PBRPC_BOOST_ASIO_RAW_SOCKET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_RAW_SOCKET_SERVICE_HPP
...
#else
  : public sofa::pbrpc::boost::asio::detail::service_base<raw_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit raw_socket_service(sofa::pbrpc::boost::asio::io_service& io_service)
...
#endif // SOFA_PBRPC_BOOST_ASIO_RAW_SOCKET_SERVICE_HPP
