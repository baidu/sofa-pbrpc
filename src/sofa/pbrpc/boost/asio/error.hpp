...
#ifndef SOFA_PBRPC_BOOST_ASIO_ERROR_HPP
#define SOFA_PBRPC_BOOST_ASIO_ERROR_HPP
...
inline const sofa::pbrpc::boost::system::error_category& get_system_category()
{
  return sofa::pbrpc::boost::system::system_category();
}

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

extern BOOST_ASIO_DECL
const sofa::pbrpc::boost::system::error_category& get_netdb_category();

extern BOOST_ASIO_DECL
const sofa::pbrpc::boost::system::error_category& get_addrinfo_category();

#else // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const sofa::pbrpc::boost::system::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const sofa::pbrpc::boost::system::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern BOOST_ASIO_DECL
const sofa::pbrpc::boost::system::error_category& get_misc_category();

static const sofa::pbrpc::boost::system::error_category& system_category
  = sofa::pbrpc::boost::asio::error::get_system_category();
static const sofa::pbrpc::boost::system::error_category& netdb_category
  = sofa::pbrpc::boost::asio::error::get_netdb_category();
static const sofa::pbrpc::boost::system::error_category& addrinfo_category
  = sofa::pbrpc::boost::asio::error::get_addrinfo_category();
static const sofa::pbrpc::boost::system::error_category& misc_category
  = sofa::pbrpc::boost::asio::error::get_misc_category();
...
template<> struct is_error_code_enum<sofa::pbrpc::boost::asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<sofa::pbrpc::boost::asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<sofa::pbrpc::boost::asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<sofa::pbrpc::boost::asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline sofa::pbrpc::boost::system::error_code make_error_code(basic_errors e)
{
  return sofa::pbrpc::boost::system::error_code(
      static_cast<int>(e), get_system_category());
}

inline sofa::pbrpc::boost::system::error_code make_error_code(netdb_errors e)
{
  return sofa::pbrpc::boost::system::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline sofa::pbrpc::boost::system::error_code make_error_code(addrinfo_errors e)
{
  return sofa::pbrpc::boost::system::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline sofa::pbrpc::boost::system::error_code make_error_code(misc_errors e)
{
  return sofa::pbrpc::boost::system::error_code(
...
# include <sofa/pbrpc/boost/asio/impl/error.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_ERROR_HPP
