...
#ifndef SOFA_PBRPC_BOOST_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
#define SOFA_PBRPC_BOOST_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
...
public:
  ...
  {
    return sizeof(sofa::pbrpc::boost::asio::detail::sockaddr_un_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    sofa::pbrpc::boost::asio::detail::sockaddr_un_type local;
  } data_;
...
# include <sofa/pbrpc/boost/asio/local/detail/impl/endpoint.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // defined(BOOST_ASIO_HAS_LOCAL_SOCKETS)

#endif // SOFA_PBRPC_BOOST_ASIO_LOCAL_DETAIL_ENDPOINT_HPP
