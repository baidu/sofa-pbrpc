...
#ifndef SOFA_PBRPC_BOOST_ASIO_STRAND_HPP
#define SOFA_PBRPC_BOOST_ASIO_STRAND_HPP
...
#include <sofa/pbrpc/boost/asio/detail/strand_service.hpp>
...
public:
   ...
   */
  explicit strand(sofa::pbrpc::boost::asio::io_service& io_service)
    : service_(sofa::pbrpc::boost::asio::use_service<
        sofa::pbrpc::boost::asio::detail::strand_service>(io_service))
  {
   ...
   * @code strand.dispatch(sofa::pbrpc::boost::bind(f, a1, ... an)); @endcode
   */
...
private:
  sofa::pbrpc::boost::asio::detail::strand_service& service_;
  sofa::pbrpc::boost::asio::detail::strand_service::implementation_type impl_;
};

/// (Deprecated: Use sofa::pbrpc::boost::asio::io_service::strand.) Typedef for backwards
/// compatibility.
typedef sofa::pbrpc::boost::asio::io_service::strand strand;
...
#endif // SOFA_PBRPC_BOOST_ASIO_STRAND_HPP
