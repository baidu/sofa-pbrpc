...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_IMPL_ENDPOINT_IPP
#define SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_IMPL_ENDPOINT_IPP
...
#include <sofa/pbrpc/boost/asio/ip/detail/endpoint.hpp>
  ...
  : data_()
{
  ...
  if (family == BOOST_ASIO_OS_DEF(AF_INET))
  {
    data_.v4.sin_family = BOOST_ASIO_OS_DEF(AF_INET);
    data_.v4.sin_port =
      sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_short(port_num);
    data_.v4.sin_addr.s_addr = BOOST_ASIO_OS_DEF(INADDR_ANY);
  }
  else
  {
...
endpoint::endpoint(const sofa::pbrpc::boost::asio::ip::address& addr,
  ...
  : data_()
{
  ...
  if (addr.is_v4())
  {
    ...
    data_.v4.sin_addr.s_addr =
      sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_long(
          static_cast<sofa::pbrpc::boost::asio::detail::u_long_type>(
            addr.to_v4().to_ulong()));
  }
  else
  {
    ...
    data_.v6.sin6_port =
      sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_short(port_num);
    data_.v6.sin6_flowinfo = 0;
    sofa::pbrpc::boost::asio::ip::address_v6 v6_addr = addr.to_v6();
    sofa::pbrpc::boost::asio::ip::address_v6::bytes_type bytes = v6_addr.to_bytes();
...
unsigned short endpoint::port() const
{
  if (is_v4())
  {
    return sofa::pbrpc::boost::asio::detail::socket_ops::network_to_host_short(
        data_.v4.sin_port);
  }
  else
  {
...
sofa::pbrpc::boost::asio::ip::address endpoint::address() const
{
  using namespace std; // For memcpy.
  if (is_v4())
  {
    return sofa::pbrpc::boost::asio::ip::address_v4(
        sofa::pbrpc::boost::asio::detail::socket_ops::network_to_host_long(
          data_.v4.sin_addr.s_addr));
  }
  else
  {
    sofa::pbrpc::boost::asio::ip::address_v6::bytes_type bytes;
#if defined(BOOST_ASIO_HAS_STD_ARRAY)
    memcpy(bytes.data(), data_.v6.sin6_addr.s6_addr, 16);
#else // defined(BOOST_ASIO_HAS_STD_ARRAY)
    memcpy(bytes.elems, data_.v6.sin6_addr.s6_addr, 16);
#endif // defined(BOOST_ASIO_HAS_STD_ARRAY)
    return sofa::pbrpc::boost::asio::ip::address_v6(bytes, data_.v6.sin6_scope_id);
  }
}

void endpoint::address(const sofa::pbrpc::boost::asio::ip::address& addr)
{
...
#if !defined(BOOST_ASIO_NO_IOSTREAM)
std::string endpoint::to_string(sofa::pbrpc::boost::system::error_code& ec) const
{
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_IMPL_ENDPOINT_IPP
