...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  explicit multicast_request(const sofa::pbrpc::boost::asio::ip::address& multicast_address)
    : ipv4_value_(), // Zero-initialisation gives the "any" address.
      ipv6_value_() // Zero-initialisation gives the "any" address.
  {
    if (multicast_address.is_v6())
    {
      ...
      sofa::pbrpc::boost::asio::ip::address_v6 ipv6_address = multicast_address.to_v6();
      sofa::pbrpc::boost::asio::ip::address_v6::bytes_type bytes = ipv6_address.to_bytes();
    ...
    else
    {
      ...
      ipv4_value_.imr_interface.s_addr =
        sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_long(
            sofa::pbrpc::boost::asio::ip::address_v4::any().to_ulong());
    }
  }

  // Construct with multicast address and IPv4 address specifying an interface.
  explicit multicast_request(
      const sofa::pbrpc::boost::asio::ip::address_v4& multicast_address,
      const sofa::pbrpc::boost::asio::ip::address_v4& network_interface
        = sofa::pbrpc::boost::asio::ip::address_v4::any())
    : ipv6_value_() // Zero-initialisation gives the "any" address.
  {
    ipv4_value_.imr_multiaddr.s_addr =
      sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_long(
  ...
  explicit multicast_request(
      const sofa::pbrpc::boost::asio::ip::address_v6& multicast_address,
...
private:
  sofa::pbrpc::boost::asio::detail::in4_mreq_type ipv4_value_;
  sofa::pbrpc::boost::asio::detail::in6_mreq_type ipv6_value_;
};
...
public:
  ...
  explicit network_interface(const sofa::pbrpc::boost::asio::ip::address_v4& ipv4_interface)
  {
    ipv4_value_.s_addr =
      sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_long(
...
private:
  sofa::pbrpc::boost::asio::detail::in4_addr_type ipv4_value_;
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
