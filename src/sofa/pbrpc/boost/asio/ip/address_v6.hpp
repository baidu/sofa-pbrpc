...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_V6_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_V6_HPP
...
/**
 * The sofa::pbrpc::boost::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef sofa::pbrpc::boost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  sofa::pbrpc::boost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates sofa::pbrpc::boost::asio::ip::address_v6
 */
...
#include <sofa/pbrpc/boost/asio/ip/impl/address_v6.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/ip/impl/address_v6.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_V6_HPP
