...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
...
# include <sofa/pbrpc/boost/asio/detail/winrt_utils.hpp>
...
/**
 * The sofa::pbrpc::boost::asio::ip::basic_resolver_iterator class template is used to define
...
public:
  ...
  static basic_resolver_iterator create(
      sofa::pbrpc::boost::asio::detail::addrinfo_type* address_info,
  ...
  static basic_resolver_iterator create(
      ...
      const sofa::pbrpc::boost::asio::detail::addrinfo_type& hints,
      const std::string& host_name, const std::string& service_name)
  {
    basic_resolver_iterator iter;
    if (endpoints->Size)
            ...
            basic_resolver_entry<InternetProtocol>(
              typename InternetProtocol::endpoint(
                ip::address::from_string(
                  sofa::pbrpc::boost::asio::detail::winrt_utils::string(
                    pair->RemoteHostName->CanonicalName)),
                sofa::pbrpc::boost::asio::detail::winrt_utils::integer(
...
private:
  ...
  sofa::pbrpc::boost::asio::detail::shared_ptr<values_type> values_;
  std::size_t index_;
};
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
