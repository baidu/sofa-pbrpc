...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
...
/**
 * The sofa::pbrpc::boost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const sofa::pbrpc::boost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  sofa::pbrpc::boost::asio::detail::addrinfo_type hints_;
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
