...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_V6_ONLY_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_V6_ONLY_HPP
 ...
 * ...
 * sofa::pbrpc::boost::asio::ip::v6_only option(true);
 ...
 * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
 * ...
 * sofa::pbrpc::boost::asio::ip::v6_only option;
...
typedef sofa::pbrpc::boost::asio::detail::socket_option::boolean<
    ...
    sofa::pbrpc::boost::asio::detail::always_fail_option> v6_only;
#endif
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_V6_ONLY_HPP
