...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_HPP
...
/**
 * The sofa::pbrpc::boost::asio::ip::address class provides the ability to use either IP
...
public:
  ...
  BOOST_ASIO_DECL address(const sofa::pbrpc::boost::asio::ip::address_v4& ipv4_address);

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(const sofa::pbrpc::boost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL address& operator=(
      const sofa::pbrpc::boost::asio::ip::address_v4& ipv4_address);

  /// Assign from an IPv6 address.
  BOOST_ASIO_DECL address& operator=(
      const sofa::pbrpc::boost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL sofa::pbrpc::boost::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL sofa::pbrpc::boost::asio::ip::address_v6 to_v6() const;
  ...
  BOOST_ASIO_DECL static address from_string(
      const char* str, sofa::pbrpc::boost::system::error_code& ec);
  ...
  /// or from an IPv6 address in hexadecimal notation.
  BOOST_ASIO_DECL static address from_string(
      const std::string& str, sofa::pbrpc::boost::system::error_code& ec);
...
private:
  ...
  sofa::pbrpc::boost::asio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  sofa::pbrpc::boost::asio::ip::address_v6 ipv6_address_;
};
 ...
 *
 * @relates sofa::pbrpc::boost::asio::ip::address
 */
...
#include <sofa/pbrpc/boost/asio/ip/impl/address.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include <sofa/pbrpc/boost/asio/ip/impl/address.ipp>
#endif // defined(BOOST_ASIO_HEADER_ONLY)

#endif // SOFA_PBRPC_BOOST_ASIO_IP_ADDRESS_HPP
