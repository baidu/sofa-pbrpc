...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_ICMP_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_ICMP_HPP
...
/**
 * The sofa::pbrpc::boost::asio::ip::icmp class contains flags necessary for ICMP sockets.
 *
 * @par Thread Safety
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_ICMP_HPP
