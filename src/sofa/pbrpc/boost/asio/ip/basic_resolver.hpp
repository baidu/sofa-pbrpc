...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
...
public:
   ...
   */
  explicit basic_resolver(sofa::pbrpc::boost::asio::io_service& io_service)
   ...
   * will be invoked with the sofa::pbrpc::boost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, sofa::pbrpc::boost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, sofa::pbrpc::boost::system::error_code& ec)
  {
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
