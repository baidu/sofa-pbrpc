...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_IMPL_ADDRESS_V4_IPP
#define SOFA_PBRPC_BOOST_ASIO_IP_IMPL_ADDRESS_V4_IPP
...
address_v4::address_v4(unsigned long addr)
{
  ...
  addr_.s_addr = sofa::pbrpc::boost::asio::detail::socket_ops::host_to_network_long(
      static_cast<sofa::pbrpc::boost::asio::detail::u_long_type>(addr));
}
...
{
  return sofa::pbrpc::boost::asio::detail::socket_ops::network_to_host_long(addr_.s_addr);
}
...
std::string address_v4::to_string(sofa::pbrpc::boost::system::error_code& ec) const
{
  char addr_str[sofa::pbrpc::boost::asio::detail::max_addr_v4_str_len];
  const char* addr =
    sofa::pbrpc::boost::asio::detail::socket_ops::inet_ntop(
        BOOST_ASIO_OS_DEF(AF_INET), &addr_, addr_str,
        sofa::pbrpc::boost::asio::detail::max_addr_v4_str_len, 0, ec);
  if (addr == 0)
    return std::string();
  return addr;
}
...
{
  address_v4 tmp;
  if (sofa::pbrpc::boost::asio::detail::socket_ops::inet_pton(
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_IMPL_ADDRESS_V4_IPP
