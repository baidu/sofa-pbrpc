...
#ifndef SOFA_PBRPC_BOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
#define SOFA_PBRPC_BOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
...
{
  sofa::pbrpc::boost::asio::ip::detail::endpoint tmp_ep(endpoint.address(), endpoint.port());
...
#endif // SOFA_PBRPC_BOOST_ASIO_IP_IMPL_BASIC_ENDPOINT_HPP
