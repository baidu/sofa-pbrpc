...
#ifndef SOFA_PBRPC_BOOST_ASIO_SOCKET_BASE_HPP
#define SOFA_PBRPC_BOOST_ASIO_SOCKET_BASE_HPP
...
#include <sofa/pbrpc/boost/asio/detail/io_control.hpp>
...
public:
   ...
   * ...
   * sofa::pbrpc::boost::asio::socket_base::broadcast option(true);
   ...
   * sofa::pbrpc::boost::asio::ip::udp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::broadcast option;
   ...
   * ...
   * sofa::pbrpc::boost::asio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * sofa::pbrpc::boost::asio::ip::udp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::udp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef sofa::pbrpc::boost::asio::detail::socket_option::integer<
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * sofa::pbrpc::boost::asio::socket_base::reuse_address option(true);
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::acceptor acceptor(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::reuse_address option;
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef sofa::pbrpc::boost::asio::detail::socket_option::linger<
   ...
   * operation is permitted to fail with sofa::pbrpc::boost::asio::error::connection_aborted.
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::acceptor acceptor(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::acceptor acceptor(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
...
#else
  typedef sofa::pbrpc::boost::asio::detail::socket_option::boolean<
    sofa::pbrpc::boost::asio::detail::custom_socket_option_level,
    sofa::pbrpc::boost::asio::detail::enable_connection_aborted_option>
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::non_blocking_io command(true);
...
#else
  typedef sofa::pbrpc::boost::asio::detail::io_control::non_blocking_io non_blocking_io;
#endif
   ...
   * sofa::pbrpc::boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * sofa::pbrpc::boost::asio::socket_base::bytes_readable command(true);
   * socket.io_control(command);
...
#else
  typedef sofa::pbrpc::boost::asio::detail::io_control::bytes_readable bytes_readable;
#endif
...
#endif // SOFA_PBRPC_BOOST_ASIO_SOCKET_BASE_HPP
