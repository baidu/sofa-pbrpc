...
#ifndef SOFA_PBRPC_BOOST_ASIO_SIGNAL_SET_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_SIGNAL_SET_SERVICE_HPP
...
#else
  : public sofa::pbrpc::boost::asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(sofa::pbrpc::boost::asio::io_service& io_service)
    : sofa::pbrpc::boost::asio::detail::service_base<signal_set_service>(io_service),
  ...
  sofa::pbrpc::boost::system::error_code add(implementation_type& impl,
  ...
  sofa::pbrpc::boost::system::error_code remove(implementation_type& impl,
      int signal_number, sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  sofa::pbrpc::boost::system::error_code clear(implementation_type& impl,
      ...
      BOOST_ASIO_MOVE_ARG(SignalHandler) handler)
  {
    detail::async_result_init<
      SignalHandler, void (sofa::pbrpc::boost::system::error_code, int)> init(
...
#endif // SOFA_PBRPC_BOOST_ASIO_SIGNAL_SET_SERVICE_HPP
