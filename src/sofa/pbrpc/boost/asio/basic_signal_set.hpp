...
#ifndef SOFA_PBRPC_BOOST_ASIO_BASIC_SIGNAL_SET_HPP
#define SOFA_PBRPC_BOOST_ASIO_BASIC_SIGNAL_SET_HPP
 ...
 *
 * Most applications will use the sofa::pbrpc::boost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * sofa::pbrpc::boost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(sofa::pbrpc::boost::asio::io_service& io_service)
   ...
   * @code sofa::pbrpc::boost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(sofa::pbrpc::boost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    sofa::pbrpc::boost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  sofa::pbrpc::boost::system::error_code add(int signal_number,
      sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  sofa::pbrpc::boost::system::error_code remove(int signal_number,
      sofa::pbrpc::boost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    sofa::pbrpc::boost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  sofa::pbrpc::boost::system::error_code clear(sofa::pbrpc::boost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the sofa::pbrpc::boost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code sofa::pbrpc::boost::asio::error::operation_aborted.
   *
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(SignalHandler,
      void (sofa::pbrpc::boost::system::error_code, int))
...
#endif // SOFA_PBRPC_BOOST_ASIO_BASIC_SIGNAL_SET_HPP
