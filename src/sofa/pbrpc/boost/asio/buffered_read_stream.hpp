...
#ifndef SOFA_PBRPC_BOOST_ASIO_BUFFERED_READ_STREAM_HPP
#define SOFA_PBRPC_BOOST_ASIO_BUFFERED_READ_STREAM_HPP
...
#include <sofa/pbrpc/boost/asio/detail/buffer_resize_guard.hpp>
#include <sofa/pbrpc/boost/asio/detail/buffered_stream_storage.hpp>
...
public:
      ...
      BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    next_layer_.async_write_some(buffers,
        BOOST_ASIO_MOVE_CAST(BOOST_ASIO_HANDLER_TYPE(WriteHandler,
            void (sofa::pbrpc::boost::system::error_code, std::size_t)))(init.handler));
  ...
  std::size_t fill(sofa::pbrpc::boost::system::error_code& ec);
  ...
  /// Determine the amount of data that may be read without blocking.
  std::size_t in_avail(sofa::pbrpc::boost::system::error_code& ec)
  {
...
private:
  ...
  {
    std::size_t bytes_copied = sofa::pbrpc::boost::asio::buffer_copy(
  ...
  {
    return sofa::pbrpc::boost::asio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
...
#include <sofa/pbrpc/boost/asio/impl/buffered_read_stream.hpp>

#endif // SOFA_PBRPC_BOOST_ASIO_BUFFERED_READ_STREAM_HPP
