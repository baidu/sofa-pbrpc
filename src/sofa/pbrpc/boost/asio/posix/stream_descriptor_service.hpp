...
#ifndef SOFA_PBRPC_BOOST_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
#define SOFA_PBRPC_BOOST_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
...
#else
  : public sofa::pbrpc::boost::asio::detail::service_base<stream_descriptor_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_descriptor_service(sofa::pbrpc::boost::asio::io_service& io_service)
    : sofa::pbrpc::boost::asio::detail::service_base<stream_descriptor_service>(io_service),
...
#endif // SOFA_PBRPC_BOOST_ASIO_POSIX_STREAM_DESCRIPTOR_SERVICE_HPP
