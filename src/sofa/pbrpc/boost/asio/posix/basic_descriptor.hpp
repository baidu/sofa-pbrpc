...
#ifndef SOFA_PBRPC_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
#define SOFA_PBRPC_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(sofa::pbrpc::boost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(sofa::pbrpc::boost::asio::io_service& io_service,
   ...
   */
  sofa::pbrpc::boost::system::error_code assign(const native_handle_type& native_descriptor,
      sofa::pbrpc::boost::system::error_code& ec)
  {
   ...
   * sofa::pbrpc::boost::asio::posix::descriptor_base::bytes_readable @n
   * sofa::pbrpc::boost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * sofa::pbrpc::boost::asio::posix::stream_descriptor descriptor(io_service);
   * ...
   * sofa::pbrpc::boost::asio::posix::stream_descriptor::bytes_readable command;
...
#endif // SOFA_PBRPC_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_HPP
