...
#ifndef SOFA_PBRPC_BOOST_LIMITS_HPP
#define SOFA_PBRPC_BOOST_LIMITS_HPP
...
#else
#  define BOOST_LLT  ::sofa::pbrpc::boost::long_long_type
#  define BOOST_ULLT  ::sofa::pbrpc::boost::ulong_long_type
#endif
