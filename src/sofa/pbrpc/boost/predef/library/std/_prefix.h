...
*/
#ifndef SOFA_PBRPC_BOOST_PREDEF_LIBRARY_STD__PREFIX_H
#define SOFA_PBRPC_BOOST_PREDEF_LIBRARY_STD__PREFIX_H
...
Boost.TR1 library.
*/
#include <sofa/pbrpc/boost/predef/detail/_exception.h>
