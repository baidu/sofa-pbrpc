...
#ifndef SOFA_PBRPC_BOOST_PREDEF_COMPILER_MINGW_H
#define SOFA_PBRPC_BOOST_PREDEF_COMPILER_MINGW_H
...
#   endif
#   include <sofa/pbrpc/boost/predef/detail/platform_detected.h>
#endif
