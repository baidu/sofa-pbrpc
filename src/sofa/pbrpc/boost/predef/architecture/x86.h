...
#ifndef SOFA_PBRPC_BOOST_PREDEF_ARCHITECTURE_X86_H
#define SOFA_PBRPC_BOOST_PREDEF_ARCHITECTURE_X86_H

#include <sofa/pbrpc/boost/predef/architecture/x86/32.h>
#include <sofa/pbrpc/boost/predef/architecture/x86/64.h>
