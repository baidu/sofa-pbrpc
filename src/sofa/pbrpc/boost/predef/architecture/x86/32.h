...
#ifndef SOFA_PBRPC_BOOST_PREDEF_ARCHITECTURE_X86_32_H
#define SOFA_PBRPC_BOOST_PREDEF_ARCHITECTURE_X86_32_H
...
#include <sofa/pbrpc/boost/predef/architecture/x86.h>
