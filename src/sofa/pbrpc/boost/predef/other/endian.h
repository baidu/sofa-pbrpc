...
#ifndef SOFA_PBRPC_BOOST_PREDEF_ENDIAN_H
#define SOFA_PBRPC_BOOST_PREDEF_ENDIAN_H

#include <sofa/pbrpc/boost/predef/version_number.h>
#include <sofa/pbrpc/boost/predef/make.h>
#include <sofa/pbrpc/boost/predef/library/c/gnu.h>
#include <sofa/pbrpc/boost/predef/os/macos.h>
...
#if !BOOST_ENDIAN_BIG_BYTE && !BOOST_ENDIAN_BIG_WORD && \
    !BOOST_ENDIAN_LITTLE_BYTE && !BOOST_ENDIAN_LITTLE_WORD
#   include <sofa/pbrpc/boost/predef/architecture.h>
#   if BOOST_ARCH_M68K || \
        BOOST_ARCH_PARISK || \
        BOOST_ARCH_SPARC || \
        BOOST_ARCH_SYS370 || \
 ...
 */
    ...
    !BOOST_ENDIAN_LITTLE_BYTE && !BOOST_ENDIAN_LITTLE_WORD
#   if BOOST_ARCH_ARM
#       include <sofa/pbrpc/boost/predef/os/windows.h>
#       if BOOST_OS_WINDOWS
#           undef BOOST_ENDIAN_LITTLE_BYTE
#           define BOOST_ENDIAN_LITTLE_BYTE BOOST_VERSION_NUMBER_AVAILABLE
#       endif
...
#include <sofa/pbrpc/boost/predef/detail/test.h>
