...
#ifndef SOFA_PBRPC_BOOST_NEXT_PRIOR_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_NEXT_PRIOR_HPP_INCLUDED

#include <iterator>
#include <sofa/pbrpc/boost/type_traits/is_unsigned.hpp>
#include <sofa/pbrpc/boost/type_traits/integral_promotion.hpp>
#include <sofa/pbrpc/boost/type_traits/make_signed.hpp>
#include <sofa/pbrpc/boost/type_traits/has_plus.hpp>
#include <sofa/pbrpc/boost/type_traits/has_plus_assign.hpp>
#include <sofa/pbrpc/boost/type_traits/has_minus.hpp>
#include <sofa/pbrpc/boost/type_traits/has_minus_assign.hpp>
...
//    const std::list<T>::iterator prev = sofa::pbrpc::boost::prior(p);
//    const std::list<T>::iterator next = sofa::pbrpc::boost::next(prev, 2);
...
#endif  // SOFA_PBRPC_BOOST_NEXT_PRIOR_HPP_INCLUDED
