#ifndef SOFA_PBRPC_BOOST_CORE_REF_HPP
#define SOFA_PBRPC_BOOST_CORE_REF_HPP
...
public:
    ...
    */
    BOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(sofa::pbrpc::boost::addressof(t)) {}

#if defined( BOOST_MSVC ) && BOOST_WORKAROUND( BOOST_MSVC, == 1600 )

    BOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( sofa::pbrpc::boost::addressof( t ) ) {}
...
#endif // #ifndef SOFA_PBRPC_BOOST_CORE_REF_HPP
