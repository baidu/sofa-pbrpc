#ifndef SOFA_PBRPC_BOOST_CORE_TYPEINFO_HPP_INCLUDED
#define SOFA_PBRPC_BOOST_CORE_TYPEINFO_HPP_INCLUDED
...
{
    static sofa::pbrpc::boost::core::typeinfo ti_;
...
template<class T> sofa::pbrpc::boost::core::typeinfo core_typeid_< T >::ti_ = core_typeid_< T >::name();
#else
template<class T> sofa::pbrpc::boost::core::typeinfo core_typeid_< T >::ti_(core_typeid_< T >::name());
#endif
...
#define BOOST_CORE_TYPEID(T) (sofa::pbrpc::boost::detail::core_typeid_<T>::ti_)

#else

#include <sofa/pbrpc/boost/core/demangle.hpp>
#include <typeinfo>
...
#endif  // #ifndef SOFA_PBRPC_BOOST_CORE_TYPEINFO_HPP_INCLUDED
