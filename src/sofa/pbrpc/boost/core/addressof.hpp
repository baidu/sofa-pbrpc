...
#ifndef SOFA_PBRPC_BOOST_CORE_ADDRESSOF_HPP
#define SOFA_PBRPC_BOOST_CORE_ADDRESSOF_HPP
...
T * addressof( T & v )
{
    ...
    return sofa::pbrpc::boost::detail::addressof_impl<T>::f( v, 0 );

#else

    return sofa::pbrpc::boost::detail::addressof_impl<T>::f( sofa::pbrpc::boost::detail::addr_impl_ref<T>( v ), 0 );
...
#endif // SOFA_PBRPC_BOOST_CORE_ADDRESSOF_HPP
